...
argument_list|)
decl_stmt|;
comment|//return Response.status(404).header("Content-Location", jobService).header("Content-type","text/html").entity( viewable ).build();
name|ResponseBuilder
name|rb
init|=
name|Response
...
argument_list|)
expr_stmt|;
comment|//return Response.status(Response.Status.NOT_FOUND).build();
name|ResponseBuilder
name|rb
init|=
name|Response

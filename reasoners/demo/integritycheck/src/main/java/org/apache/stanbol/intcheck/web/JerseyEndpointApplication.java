...
expr_stmt|;
comment|//OK
comment|//classes.add(ReasoningResource.class);//OK
name|classes
operator|.
name|add
argument_list|(
...
expr_stmt|;
comment|//OK
comment|//classes.add(DocumentationResource.class);//OK
comment|//classes.add(RootResource.class);
...
comment|//classes.add(ReengineerResource.class);
comment|//classes.add(RefactorerResource.class);
comment|//classes.add(GraphsResource.class);
return|return
name|classes
return|;
block|}

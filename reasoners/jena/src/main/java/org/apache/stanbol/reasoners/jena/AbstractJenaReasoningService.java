...
name|debug
argument_list|(
literal|" run(Model data, List<Rule> rules)"
argument_list|)
expr_stmt|;
name|InfGraph
name|inferredGraph
...
name|debug
argument_list|(
literal|" runTask(String taskID,Model data,List<Rule> rules,boolean filtered,Map<String,List<String>> parameters)"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|" runTask(String taskID, Model data)"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|" customReasoner(List<Rule> customRules)"
argument_list|)
expr_stmt|;
name|List
argument_list|<
...
name|debug
argument_list|(
literal|" classify(Model data, List<Rule> rules)"
argument_list|)
expr_stmt|;
return|return
name|run
...
name|debug
argument_list|(
literal|" enrich(Model data, boolean filtered)"
argument_list|)
expr_stmt|;
comment|// Since the input model is modified by the reasoner,
comment|// We keep the original list to prune the data after, if necessary
if|if
condition|(
name|filtered
condition|)
...
name|debug
argument_list|(
literal|" original statements are: {}"
argument_list|,
name|original
operator|.
name|size
...
name|debug
argument_list|(
literal|" inferred statements are: {}"
argument_list|,
name|inferred
operator|.
name|size
...
name|debug
argument_list|(
literal|" prune(Set<Statement> first[{}], Set<Statement> second[{}])"
argument_list|,
name|first
operator|.
name|size
...
name|debug
argument_list|(
literal|" ---- removing {} statements from {}"
argument_list|,
name|first
operator|.
name|size
...
name|debug
argument_list|(
literal|" enrich(Model data, List<Rule> rules, boolean filtered)"
argument_list|)
expr_stmt|;
comment|// Since the input model is modified by the reasoner,
comment|// We keep the original list to prune the data after, if necessary
...
name|debug
argument_list|(
literal|" enrich(Model data, List<Rule> rules)"
argument_list|)
expr_stmt|;
return|return
name|enrich
...
name|debug
argument_list|(
literal|" isConsistent(Model data)"
argument_list|)
expr_stmt|;
return|return
name|isConsistent
...
name|debug
argument_list|(
literal|" isConsistent(Model data, List<Rule> rules)"
argument_list|)
expr_stmt|;
return|return
name|isConsistent
...
name|debug
argument_list|(
literal|" isConsistent(ValidityReport report)"
argument_list|)
expr_stmt|;
if|if
condition|(

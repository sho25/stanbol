...
begin_comment
comment|/**  * Implementation of the standard {@see ReasoningServicesManager}  * This is only intended to be used in OSGi environments.  *   * @author enridaga  *   * @scr.component immediate="true"  * @scr.service  * @scr.reference name="ReasoningService"  *                interface="org.apache.stanbol.reasoners.servicesapi.ReasoningService" cardinality="0..n"  *                policy="dynamic")  */
end_comment

...
expr_stmt|;
block|}
comment|/**      * OWL2 + CLASSIFY + text/html      *       * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
name|testServiceOnlineOwl2ClassifyFoafHtml
parameter_list|()
throws|throws
name|Exception
block|{
...
name|buildGetRequest
argument_list|(
literal|"/reasoners/owl2/classify"
argument_list|,
literal|"url"
argument_list|,
name|FOAF
...
name|assertContentRegexp
argument_list|(
literal|"&lt;http://purl.org/dc/terms/Agent&gt;"
argument_list|,
literal|"&lt;http://xmlns.com/foaf/0.1/Agent&gt;"
argument_list|,
literal|"owl:Thing"
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**      * OWL2 + ENRICH + application/turtle      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
name|testServiceOnlineOwl2EnrichFoafTurtle
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertContentRegexp
argument_list|(
literal|"rdfs:subClassOf\\s+<http://purl.org/dc/terms/Agent>"
argument_list|,
literal|"owl:disjointWith\\s+<http://xmlns.com/foaf/0.1/Project>"
argument_list|)
expr_stmt|;
block|}
block|}

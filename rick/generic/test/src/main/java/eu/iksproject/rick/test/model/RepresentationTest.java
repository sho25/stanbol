...
block|{
comment|/**      * Subclasses must implement this method and provide a {@link ValueFactory}      * instance that is used to test the actual model implementation      * @return the {@link ValueFactory} for the RICK model implementation to be      * tested      */
specifier|protected
specifier|abstract
name|ValueFactory
...
parameter_list|()
function_decl|;
comment|/*--------------------------------------------------------------------------      * Set of Tests that check if all Methods correctly throw a NullPointerException      * when parsing null as field!      *  - important to prevent NULL fields within the RICK      *--------------------------------------------------------------------------      */
annotation|@
name|Test
argument_list|(
name|expected
...
expr_stmt|;
block|}
comment|/*--------------------------------------------------------------------------      * Set of Tests that check if all Methods correctly throw a IllegalArgumentExceptions      * when parsing an empty string as field      *  - important to prevent "" fields within the RICK      *--------------------------------------------------------------------------      */
annotation|@
name|Test
argument_list|(
name|expected
...
expr_stmt|;
block|}
comment|/*--------------------------------------------------------------------------      * Set of Tests that check if all add methods correctly throw an       * IllegalArgumentExceptions when parsing NULL as value      *  - important to prevent NULL values within RICK      *--------------------------------------------------------------------------      */
annotation|@
name|Test
argument_list|(
name|expected

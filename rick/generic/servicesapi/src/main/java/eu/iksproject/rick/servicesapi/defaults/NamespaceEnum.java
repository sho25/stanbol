...
comment|//		for(NamespaceEnum entry : NamespaceEnum.values()){
comment|//			System.out.println(String.format("forNamespace(%s)=%s == %s",entry.getNamespace(),forNamespace(entry.getNamespace()).getPrefix(),entry.getPrefix()));
comment|//		}
comment|//	}
block|}
end_enum

...
init|=
literal|"CREATE TABLE factcontexts ( id INT GENERATED ALWAYS AS IDENTITY CONSTRAINT context_id PRIMARY KEY, created TIMESTAMP, updated TIMESTAMP, validFrom TIMESTAMP, validTo TIMESTAMP, contextURN VARCHAR(1024) )"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
name|append
argument_list|(
literal|", context_id INT NOT NULL CONSTRAINT "
argument_list|)
expr_stmt|;
name|createTableSQL
operator|.
...
comment|//createTableSQL.append(", created TIMESTAMP NOT NULL WITH DEFAULT CURRENT TIMESTAMP");
name|createTableSQL
operator|.
name|append
argument_list|(
...
name|info
argument_list|(
literal|"Loading fact {} from fact table {}"
argument_list|,
name|factId
argument_list|,
name|factSchemaB64
...
name|Exception
argument_list|(
literal|"Error while selecting fact"
argument_list|,
name|e
argument_list|)
throw|;
...
name|StringBuilder
argument_list|(
literal|"INSERT INTO factcontexts (created, updated, validFrom, validTo, contextURN) VALUES (?, ?, ?, ?, ?)"
argument_list|)
decl_stmt|;
...
name|Exception
argument_list|(
literal|"Could not obtain context ID after insert"
argument_list|)
throw|;
block|}
name|logger
...
name|info
argument_list|(
literal|"Inserted new context with ID {} into factcontexts table"
argument_list|,
name|contextId
argument_list|)
expr_stmt|;

...
name|Exception
function_decl|;
comment|/**      * Interface method to *list* ontology imports of an ontology      * @param ontologyURI       *          the URI of the ontology      * @return      *          A {@link ImportsForOntology} objects.      * @throws Exception      */
name|ImportsForOntology
...
name|Exception
function_decl|;
comment|/**      * Interface method to *add* an import to an existing ontology      * @param ontologyURI      *          the URI of the ontology.      * @param importURI      *          the URI of the ontology to be imported.      * @throws Exception      */
name|void
...
name|Exception
function_decl|;
comment|/**      * Interface method to *delete* an import from an existing ontology.      * If the ontology does not import the specified one, then nothing happens.      * @param ontologyURI      *          the URI of the ontology.      * @param importURI      *          the URI of the imported ontology      * @throws Exception      */
name|void

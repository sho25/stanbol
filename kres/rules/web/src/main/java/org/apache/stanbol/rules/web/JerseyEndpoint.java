...
name|ALIAS_PROPERTY
init|=
literal|"org.apache.stanbol.rules.web.alias"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
init|=
literal|"org.apache.stanbol.rules.web.static.url"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
init|=
literal|"org.apache.stanbol.rules.web.static.classpath"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
init|=
literal|"org.apache.stanbol.rules.web.templates.classpath"
decl_stmt|;
annotation|@
name|Reference
name|HttpService
...
argument_list|)
expr_stmt|;
comment|//servletContext.setAttribute(Serializer.class.getName(), serializer);
comment|//servletContext.setAttribute(SemionReengineer.class.getName(),
comment|//        semionReengineer);
name|servletContext
operator|.
name|setAttribute
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//        servletContext.setAttribute(LinkDiscovery.class.getName(),
comment|//        		linkDiscovery);
comment|//servletContext.setAttribute(SemionManager.class.getName(),
comment|//		reengineeringManager);
comment|//servletContext.setAttribute(TcManager.class.getName(), tcManager);
comment|//	servletContext.setAttribute(KReSONManager.class.getName(), onm);

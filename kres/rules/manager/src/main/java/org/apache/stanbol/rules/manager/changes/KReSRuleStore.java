...
block|}
comment|//            } else {
comment|//                fos = new FileOutputStream(file);
comment|//                this.owlmodel.getOWLOntologyManager().saveOntology(owlmodel, fos);
comment|//            }
comment|//        } catch (OWLOntologyStorageException ex) {
comment|//            log.error("Cannot store the ontology ", ex);

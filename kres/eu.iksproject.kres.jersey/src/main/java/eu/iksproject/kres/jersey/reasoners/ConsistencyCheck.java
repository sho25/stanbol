...
name|warn
argument_list|(
literal|"KReSRuleStore with stored rules and recipes is missing in ServletContext. A new instance has been created."
argument_list|,
name|this
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Configuration file loaded from: "
operator|+
name|kresRuleStore
operator|.
name|getFilePath

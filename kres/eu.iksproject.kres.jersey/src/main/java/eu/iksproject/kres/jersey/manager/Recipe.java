...
argument_list|)
expr_stmt|;
comment|/*throw new IllegalStateException(                     "KReSRuleStore with stored rules and recipes is missing in ServletContext");*/
block|}
block|}
...
argument_list|)
decl_stmt|;
comment|//String ID = kresRuleStore.getOntology().getOntologyID().toString().replace(">","").replace("<","")+"#";
if|if
condition|(
name|uri
operator|.
...
block|{
comment|//The recipe is retrieved (import declarations point to KReS Services)
name|OWLOntology
name|onto
init|=
name|kresRuleStore

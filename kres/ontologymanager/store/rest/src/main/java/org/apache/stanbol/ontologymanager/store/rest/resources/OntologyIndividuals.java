...
name|Path
argument_list|(
literal|"/ontologies/{ontologyPath:.+}/individuals"
argument_list|)
annotation|@
name|ImplicitProduces
argument_list|(
...
name|VIEWABLE_PATH
init|=
literal|"/org/apache/stanbol/ontologymanager/store/rest/resources/ontologyIndividuals"
decl_stmt|;
specifier|private
name|PersistenceStore
name|persistenceStore
decl_stmt|;
comment|// HTML Variable
specifier|private
name|IndividualsForOntology
name|metadata
decl_stmt|;
...
specifier|public
name|Response
name|retrieveOntologyIndividuals
parameter_list|(
annotation|@
name|PathParam
argument_list|(

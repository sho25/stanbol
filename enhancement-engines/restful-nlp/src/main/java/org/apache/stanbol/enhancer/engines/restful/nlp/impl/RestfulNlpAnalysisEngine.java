...
decl_stmt|;
comment|/**      * List of HttpHeaders reused for each request. This avoids to re-create them      * for every request      */
specifier|private
specifier|static
name|List
argument_list|<
...
block|}
block|}
comment|/**      * @param ci      * @param entry      * @param in      * @param charset      * @throws EngineException      */
specifier|private
name|AnalysedText
name|parseAnalysedText
parameter_list|(

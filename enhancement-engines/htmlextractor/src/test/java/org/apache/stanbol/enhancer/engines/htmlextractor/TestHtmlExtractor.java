...
name|registry
decl_stmt|;
comment|// define the Nepomuks NIE namespace locally here
specifier|private
specifier|static
specifier|final
name|String
...
expr_stmt|;
block|}
comment|/** This test some extraction of microdata from an HTML-5 document      *       * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
name|testMicrodataExtraction
parameter_list|()
throws|throws
name|Exception
block|{

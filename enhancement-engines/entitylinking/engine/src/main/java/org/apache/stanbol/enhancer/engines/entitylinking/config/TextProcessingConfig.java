...
specifier|final
name|String
name|PARAM_CHUNKABLE_CATEGORIES
init|=
literal|"cc"
decl_stmt|;
specifier|public
...
specifier|final
name|String
name|PARAM_CHUNKABLE_POS_TYPES
init|=
literal|"cp"
decl_stmt|;
specifier|public
...
expr_stmt|;
block|}
comment|//apply chunkable parameters (STANBOL-1117)
if|if
condition|(
name|config
operator|.
...
name|info
argument_list|(
literal|" ... set chunkable Categories to {}"
argument_list|,
name|chunkableCategories
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|" ... set chunkable POS tags to {}"
argument_list|,
name|chunkablePos
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|" ... set chunkable String tags to {}"
argument_list|,
name|chunkableTags
argument_list|)
expr_stmt|;

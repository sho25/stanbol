...
argument_list|)
decl_stmt|;
comment|/**      * The default set of {@link Pos} used to match (and search) for Entities<p>      * Matched Tokens are not used for linking, but are considered when matching      * label tokens of Entities with the Text.      */
specifier|public
specifier|static
specifier|final
name|Set
...
literal|0.75
decl_stmt|;
comment|/**      * Default {@link LexicalCategory LexicalCategories} that allow the EntityLinker       * to step-over non matchable tokens when determining search tokens for       * Entityhub lookups (Defaults: {@link LexicalCategory#Noun},       * {@link LexicalCategory#Punctuation} and {@link LexicalCategory#Adposition}).      */
specifier|public
specifier|static
specifier|final
name|Set
...
name|LexicalCategory
argument_list|>
name|DEFAULT_CHUNKABLE_CATEGORIES
init|=
name|EnumSet
operator|.
name|of
...
argument_list|)
decl_stmt|;
comment|/**      * Default {@link Pos} tags that allow the EntityLinker to step-over non matchable       * tokens when determining search tokens for Entityhub lookups (default: empty).      */
specifier|private
specifier|static
specifier|final
name|Set
...
argument_list|)
decl_stmt|;
comment|/**      * Default string tags that allow the EntityLinker to step-over non matchable       * tokens when determining search tokens for Entityhub lookups (default: empty).      */
specifier|private
specifier|static
specifier|final
name|Set
...
block|}
block|}
comment|/**      * Getter for the set of {@link Pos} tags used to match label tokens of      * suggested Entities      * @return the set of {@link Pos} tags used for matching      */
specifier|public
name|Set
argument_list|<
name|Pos
...
return|;
block|}
comment|/**      * Setter for the matched {@link Pos} tags      * @param pos the set or<code>null</code>      * to set the {@link #DEFAULT_MATCHED_POS}      */
specifier|public
name|void
name|setMatchedPos
parameter_list|(
...
argument_list|(
literal|"The parsed set with matched POS tags MUST NOT contain the NULL element!"
argument_list|)
throw|;
block|}
else|else
...
expr_stmt|;
block|}
comment|/**      * Getter for the chunkable {@link LexicalCategory LexicalCategories}. Those      * allow the EntityLinker to step-over non matchable tokens when determining       * search tokens for Entityhub lookups.      * @return      */
specifier|public
name|Set
argument_list|<
name|LexicalCategory
argument_list|>
name|getChunkableCategories
parameter_list|()
block|{
return|return
name|chunkableCategories
return|;
block|}
comment|/**      * Setter for the chunkable {@link LexicalCategory LexicalCategories}. Those      * allow the EntityLinker to step-over non matchable tokens when determining       * search tokens for Entityhub lookups.      * @param categories The list of {@link LexicalCategory LexicalCategories}       * considered as chunkable or<code>null</code> to reset to the default      */
specifier|public
name|void
name|setChunkableCategories
parameter_list|(
name|Set
argument_list|<
name|LexicalCategory
...
block|}
block|}
comment|/**      * Setter for the {@link Pos} tags considered by the EntityLinker to step-over       * non matchable tokens when determining search tokens for Entityhub lookups      * @param pos The list of {@link Pos} tags considered as chunkable or       *<code>null</code> to reset to the default      */
specifier|public
name|void
name|setChunkablePos
parameter_list|(
name|Set
argument_list|<
name|Pos
...
block|}
block|}
comment|/**      * Setter for the String tags considered by the EntityLinker to step-over       * non matchable tokens when determining search tokens for Entityhub lookups      * @param tags The list of String tags considered as chunkable or       *<code>null</code> to reset to the default      */
specifier|public
name|void
name|setChunkableTags
parameter_list|(
name|Set
argument_list|<
name|String
...
block|}
block|}
comment|/**      * Getter for the {@link Pos} tags considered by the EntityLinker to step-over       * non matchable tokens when determining search tokens for Entityhub lookups      * @return      */
specifier|public
name|Set
argument_list|<
name|Pos
argument_list|>
name|getChunkablePos
parameter_list|()
block|{
return|return
name|chunkablePos
return|;
block|}
comment|/**      * Getter for the String tags considered by the EntityLinker to step-over       * non matchable tokens when determining search tokens for Entityhub lookups      * @return the String tags considered as chunkable      */
specifier|public
name|Set
argument_list|<
name|String
argument_list|>
name|getChunkableTags
parameter_list|()
block|{
return|return
name|chunkableTags

...
decl_stmt|;
comment|/**      * If enabled Suggestions with similar scores are included. This means also that      * there might me more as {@link #SUGGESTIONS} results returned by the engine.      */
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"enhancer.engines.linking.includeSimilarScore"
decl_stmt|;
...
decl_stmt|;
comment|/**      * Allows to enable/disable the inclusion of the<code>fise:entity-ranking</code>      * property to<code>fise:EntityAnnotation</code> created by the linking engine.      */
specifier|public
specifier|static
specifier|final
name|String
name|WRITE_ENTITY_RANKINGS
init|=
literal|"enhancer.engines.linking.writeEntityRankings"
decl_stmt|;
...
literal|3
decl_stmt|;
comment|/**      * By default {@link #INCLUDE_SIMILAR_SCORE} is deactivated      */
specifier|public
specifier|static
specifier|final
name|boolean
...
specifier|private
name|boolean
name|includeSuggestionsWithSimilarScore
init|=
name|DEFAULT_INCLUDE_SIMILAR_SCORE
decl_stmt|;
...
literal|true
decl_stmt|;
comment|/**      * By default the<code>fise:entity-ranking</code> property is not added to       *<code>fise:EntityAnnotation</code>.      */
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_WRITE_ENTITY_RANKINGS
init|=
literal|false
decl_stmt|;
...
expr_stmt|;
block|}
comment|//init INCLUDE_SIMILAR_SCORE
name|value
operator|=
name|configuration
operator|.
...
name|linkerConfig
operator|.
name|setIncludeSuggestionsWithSimilarScore
argument_list|(
operator|(
name|Boolean
operator|)
...
begin_comment
comment|//init WRITE ENTITY RANKINGS (STANBOL-1292)
end_comment
...
begin_comment
comment|/**      * getter for the state if<code>fise:entity-ranking</code> values should      * be added to<code>fise:EntityAnnotation</code> (if rankings are available      * for the linked datasets      * @return the write entity ranking state      */
end_comment
...
begin_comment
comment|/**      * Setter for the {@link #WRITE_ENTITY_RANKINGS} state.       * @param writeEntityRankings the state. Parse<code>null</code> to set      * to the default      */
end_comment

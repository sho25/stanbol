...
comment|//TODO: maybe make configurable via an own property
name|boolean
...
argument_list|()
expr_stmt|;
comment|//                minIncludeIndex = Math.max(
comment|//                    state.getConsumedIndex()+1,
comment|//                    token.inChunk.getStartTokenIndex());
name|maxIndcludeIndex
operator|=
name|token
operator|.
...
literal|1
expr_stmt|;
comment|//                minIncludeIndex = state.getConsumedIndex() + 1;
name|minIncludeIndex
operator|=
literal|0
expr_stmt|;
...
return|;
block|}
comment|/**      * @param searchStrings      * @param languageArray      * @param suggestions      * @param searchTokens      * @return      * @throws EntitySearcherException      */
specifier|private
name|int
name|performLookup
parameter_list|(
...
return|;
block|}
comment|/**      * Processes the parsed entity lookup results and adds suggestions to the      * parsed suggestion list      * @param results the results      * @param suggestions the suggestions      * @return the number of filtered results      */
specifier|private
name|int
name|processLookupResults
parameter_list|(

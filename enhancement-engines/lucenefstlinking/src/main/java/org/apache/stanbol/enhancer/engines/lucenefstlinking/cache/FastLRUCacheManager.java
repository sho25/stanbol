...
expr_stmt|;
block|}
comment|//still here ... looks like we need to build a new one
name|lock
operator|.
name|writeLock
argument_list|()
...
try|try
block|{
comment|//check again ... an other thread might have already built the cache
comment|//for the requested version
if|if
condition|(
name|current
operator|==
...
name|debug
argument_list|(
literal|"> close EntityCache for version {} (remaining refCount: {})"
argument_list|,
name|version
argument_list|,
name|current

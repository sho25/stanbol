...
decl_stmt|;
comment|/**      * Parameter used by the {@link #FST_CONFIG} to configure the Solr Field       * with the indexed labels used to buld the FST corpus.      */
specifier|public
specifier|static
specifier|final
name|String
...
literal|"field"
decl_stmt|;
comment|/**      * Parameter used by the {@link #FST_CONFIG} to configure the solrField with      * the stored labels. If not defined this defaults to the configured      * {@link #PARAM_FIELD}.      */
specifier|public
specifier|static
specifier|final
name|String
...
literal|"rdfs:label"
decl_stmt|;
comment|/**      * Parameter used by the {@link #FST_CONFIG} to configure the name of the fst      * file for a language      */
specifier|public
specifier|static
specifier|final
name|String
...
block|}
block|}
comment|/**      * Resolves the directory to store the FST models based on the configured      * {@link #FST_FOLDER}. Also considering the name of the SolrServer and      * SolrCore      * @param core      * @param fstFolderConfig      * @return      */
specifier|private
name|File
name|getFstDirectory
parameter_list|(
...
return|;
block|}
comment|/**      * This method combines the {@link #fstConfig} with the data present in the      * {@link SolrCore}.      * @param fstDir The directory used to look for the FST files      * @param indexReader The {@link AtomicReader} has access to the actual      * fields present in the {@link SolrCore}. It is used to compare field      * configurations in the {@link #fstConfig} with fields present in the solr      * index.      * @param indexConfig the {@link IndexConfiguration} used to store the FST      * configuration      */
specifier|private
name|boolean
name|processFstConfig
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * {@link StrSubstitutor} {@link StrLookup} implementation used for      * determining the directory for storing FST files based on the configured      * {@link FstLinkingEngineComponent#FST_FOLDER} configuration.      * @author Rupert Westenthaler      *      */
specifier|private
specifier|static
class|class
name|SolrCoreStrLookup

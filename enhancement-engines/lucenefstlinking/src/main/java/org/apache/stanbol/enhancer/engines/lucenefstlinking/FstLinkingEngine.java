...
name|debug
argument_list|(
literal|"Process Matches for {} extragted Tags:"
argument_list|,
name|tags
operator|.
name|size
...
expr_stmt|;
block|}
comment|//else the type of the current Entity is blacklisted
block|}
if|if
condition|(
name|suggestions
...
argument_list|)
expr_stmt|;
comment|//cut the list on the maximum nuber of suggestions
if|if
condition|(
name|suggestions
operator|.

...
argument_list|)
decl_stmt|;
comment|/**      * URI of the geonames.org web services used as default. Currently this is      * the server that requires authentication with a free user account. The      * server that allows anonymous requests is often overloaded and is therefore      * no longer the default. Note that the anonymous server is still used in       * case this class is initialised with the default constructor.      */
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"http://api.geonames.org/"
decl_stmt|;
comment|/**      * The geonames.org web service URI allowing anonymous connections. Often      * overloaded. Will be used with the default constructor      */
specifier|public
specifier|static
specifier|final
name|String
...
literal|"hierarchy"
decl_stmt|;
comment|/**      * The access url for the search service. As default      * {@link #DEFAULT_GEONAMES_ORG_WEBSERVICE_URL}+{@link #SEARCH_SERVICE_PATH}      * ({@value #DEFAULT_GEONAMES_ORG_WEBSERVICE_URL}{@value #SEARCH_SERVICE_PATH})      * is used. Users with a premium account including an own sub domain      * might need to change this.      */
specifier|protected
name|String
name|searchServiceUrl
decl_stmt|;
comment|/**      * The access url for the hierarchy service. As default      * {@link #DEFAULT_GEONAMES_ORG_WEBSERVICE_URL}+{@link #HIERARCHY_SERVICE_PATH}      * ({@value #DEFAULT_GEONAMES_ORG_WEBSERVICE_URL}{@value #HIERARCHY_SERVICE_PATH})      * is used. Users with a premium account including an own sub domain      * might need to change this.      */
specifier|protected
name|String
...
argument_list|(
literal|"The Token MUST NOT be NULL nor empty of a User-Name is parsed!"
argument_list|)
throw|;
block|}
name|String
name|defaultServer
decl_stmt|;
comment|//only used if the parsed service urls are null
if|if
condition|(
name|this
operator|.

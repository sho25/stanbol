...
block|}
block|}
comment|/**      * Getter for the socre in a range from [0..1]<p>      * NOTE (2014.05.27, rw): as described by STANBOL-1303 the scores returned      * by Geonames changed. So this method was adapted to calculate scores      * relative to the highest returned one.      *      * @param toponym the toponym      * @param maxScore the highest score or<code>null</code> if no highest score      * is yet known (assuming that the parsed toponym is the highest score      *      * @return the score in a range [0..1] (relative to the highest score)      */
specifier|private
name|Double
name|getToponymScore
parameter_list|(

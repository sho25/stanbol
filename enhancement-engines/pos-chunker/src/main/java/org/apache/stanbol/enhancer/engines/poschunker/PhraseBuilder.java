...
condition|)
block|{
comment|//check for prefix types and required types
name|states
operator|=
name|checkCategories
argument_list|(
...
block|{
comment|//check for continuation types
name|states
operator|=
name|checkCategories
argument_list|(
...
name|debug
argument_list|(
literal|">> ignore {} phrase with single {} "
argument_list|,
name|phraseType
operator|.
name|getPhraseType
...
name|trace
argument_list|(
literal|"  matches Category {} with score {}"
argument_list|,
name|i
argument_list|,
name|score
...
return|;
block|}
comment|/**      * used for trace level logging of Tokens part of a chunk      * @param token      * @return      */
specifier|private
name|String
name|logPosCategories
parameter_list|(

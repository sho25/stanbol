...
block|{
comment|//no POS tags or probability to low
name|cats
operator|=
name|Collections
operator|.
...
block|{
comment|//check PosTags if we need to lookup this word
name|Iterator
argument_list|<
name|Value
argument_list|<
...
block|{
comment|//in case of multiple Lexical Cats
comment|//we build the average over NOT NULL sentiments for the word
name|int
name|catSentNum
init|=
literal|0

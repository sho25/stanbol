...
expr_stmt|;
block|}
comment|/**      * Getter for the {@link NamespacePrefixService}      * @return the service or<code>null</code> if not available      * @since 0.12.1      */
specifier|public
name|NamespacePrefixService
...
return|;
block|}
comment|/**      * Parses the URIs for the {@link DereferenceConstants#ENTITY_REFERENCE_PROPERTIES}      * @return      * @throws ConfigurationException      */
specifier|private
name|Set
argument_list|<
name|IRI
...
begin_comment
comment|/** 	 * parses the {@link DereferenceConstants#DEREFERENCE_ENTITIES_LANGUAGES} property 	 * @return 	 */
end_comment

...
specifier|final
name|IRI
name|OTHER_ENTITY_REFERENCE
init|=
operator|new
name|IRI
argument_list|(
literal|"http://www.example.org/stanbol/enhancer/dereference/test#other-entity-reference"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
name|info
argument_list|(
literal|"> created {} Entity references and {} references using an alternative proeprty "
argument_list|,
name|numLinks
argument_list|,
name|numOtherLinks
...
expr_stmt|;
block|}
comment|/**      * Test for<a href="https://issues.apache.org/jira/browse/STANBOL-1334">STANBOL-1334</a>      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
name|testAsyncOtherEntityReferenceDereferencing
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAsyncMultipleEntityReferenceDereferencing
parameter_list|()
throws|throws
name|Exception
block|{

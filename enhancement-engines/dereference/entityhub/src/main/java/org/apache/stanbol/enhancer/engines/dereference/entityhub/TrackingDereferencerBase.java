...
return|;
block|}
comment|/**      * Applies the field mappings to the representation and stores the results      * in the graph      * @param uri the uri of the entity to dereference      * @param rep the data for the entity as in the entityhub      * @param graph the graph to store the mapping results      * @param writeLock the write lock for the graph      */
specifier|private
name|void
name|copyMapped
parameter_list|(

...
argument_list|(
literal|"/target/enginetest-files"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
name|info
argument_list|(
literal|"Topic Enigne Test Folder : "
operator|+
name|testRoot
argument_list|)
expr_stmt|;
...
name|Object
argument_list|>
name|configWithMissingEngineName
init|=
operator|new
name|Hashtable
argument_list|<
...
name|getResourceAsStream
argument_list|(
literal|"/sample-scheme.skos.rdf.xml"
argument_list|)
argument_list|,
name|SupportedFormat
operator|.
...
argument_list|(
literal|"http://example.com/ns#someconceptscheme/100"
argument_list|)
operator|.
name|size
argument_list|()
...
name|getBroaderConcepts
argument_list|(
literal|"http://example.com/ns#someconceptscheme/200"
argument_list|)
operator|.
name|size
argument_list|()
...
name|getBroaderConcepts
argument_list|(
literal|"http://example.com/ns#someconceptscheme/010"
argument_list|)
operator|.
name|size
argument_list|()
...
name|getBroaderConcepts
argument_list|(
literal|"http://example.com/ns#someconceptscheme/020"
argument_list|)
operator|.
name|size
argument_list|()

...
literal|0
decl_stmt|;
comment|/**      * the ServiceTracker for the {@link LabelTokenizer}      */
specifier|private
name|ServiceTracker
...
name|info
argument_list|(
literal|" ... setting LabelTokenizer of Engine '{}' to {}"
argument_list|,
name|engine
operator|.
name|getName
...
block|}
block|}
comment|//if engine or tracker is null deactivate was already called
block|}
return|return
name|service
return|;
...
name|info
argument_list|(
literal|" ... setting LabelTokenizer of Engine '{}' to null"
argument_list|,
name|engine
operator|.
name|getName

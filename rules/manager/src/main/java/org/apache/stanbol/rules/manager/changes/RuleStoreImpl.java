...
return|;
block|}
comment|/**      *       * @param recipe      *            the recipe      * @param rulesStream      *            the rule in Rule syntax      *       * @return the recipe we the new rule.      */
annotation|@
name|Override
specifier|public
name|Recipe
...
return|;
block|}
comment|/**      *       * @param recipeIRI      *            the IRI of the recipe      * @param rulesStream      *            the rule in Rule syntax      */
annotation|@
name|Override
specifier|public
name|Recipe

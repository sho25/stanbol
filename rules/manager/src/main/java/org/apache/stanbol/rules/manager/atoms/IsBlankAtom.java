...
parameter_list|)
block|{
comment|/* 		 * TODO 		String argument = uriResource.toString(); 		if(argument.startsWith("http://kres.iks-project.eu/ontology/meta/variables#")){ 			argument = "?" + argument.replace("http://kres.iks-project.eu/ontology/meta/variables#", ""); 		} 		 		java.util.List<Node> nodes = new ArrayList<Node>(); 		 		nodes.add(Node.createURI(argument)); 		 		return new Functor("isBNode", nodes); 		*/
return|return
literal|null
return|;
block|}

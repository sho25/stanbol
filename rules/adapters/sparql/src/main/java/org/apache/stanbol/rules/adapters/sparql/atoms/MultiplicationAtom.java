...
begin_comment
comment|/**  * It adapts any MultiplicationAtom to a multiplication operator in SPARQL, i.e., the * operator.  *   * @author anuzzolese  *   */
end_comment

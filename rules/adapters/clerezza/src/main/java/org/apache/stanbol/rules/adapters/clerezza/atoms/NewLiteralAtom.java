...
begin_comment
comment|/**  * It adapts any NewLiteralAtom to the BIND built in call in Clerezza for creating new literals binding the  * value to a variable.  *   * @author anuzzolese  *   */
end_comment

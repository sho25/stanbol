...
begin_comment
comment|/**  * It adapts any GreaterEqualThanAtom to greater equal than (&gt;=) binary operation for comparison in  * Clerezza.  *   * @author anuzzolese  *   */
end_comment

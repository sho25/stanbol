...
argument_list|)
decl_stmt|;
comment|//    private final String bundleSymbolicName;
comment|//    protected final SentenceModel sentenceModel;
comment|//    protected final TokenNameFinderModel personNameModel;
comment|//    protected final TokenNameFinderModel locationNameModel;
comment|//    protected final TokenNameFinderModel organizationNameModel;
comment|//    protected Map<String,Object[]> entityTypes = new HashMap<String,Object[]>();
specifier|private
specifier|static
name|Map
argument_list|<
...
name|openNLP
expr_stmt|;
comment|//        sentenceModel = openNLP.buildSentenceModel("en");
comment|//        personNameModel = buildNameModel("person", OntologicalClasses.DBPEDIA_PERSON);
comment|//        locationNameModel = buildNameModel("location", OntologicalClasses.DBPEDIA_PLACE);
comment|//        organizationNameModel = buildNameModel("organization", OntologicalClasses.DBPEDIA_ORGANISATION);
block|}
name|NEREngineCore
parameter_list|(
name|DataFileProvider

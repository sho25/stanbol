...
name|warn
argument_list|(
literal|"Zemanta Service not reachable -> offline? -> deactivate test"
argument_list|)
expr_stmt|;
return|return;
block|}
...
comment|// also include the DC_TYPE ENHANCER_CATEGORY, because such entityEnhancements
...
comment|//                Properties.ENHANCER_SELECTION_CONTEXT, null);

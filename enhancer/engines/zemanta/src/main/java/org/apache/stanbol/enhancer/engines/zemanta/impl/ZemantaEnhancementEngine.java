...
argument_list|)
decl_stmt|;
comment|/**      * The maximal prefix/suffix size used for the selection context. This is      * required, because Zemanta does only provide the Anchor text, but not the      * exact position within the text. So this engine creates a TextAnnotation      * for each occurrence of the Anchor within the text and uses the surrounding      * as context.      */
specifier|private
specifier|static
specifier|final
name|int
name|SELECTION_CONTEXT_PREFIX_SUFFIX_SIZE
init|=
literal|50
decl_stmt|;
specifier|private

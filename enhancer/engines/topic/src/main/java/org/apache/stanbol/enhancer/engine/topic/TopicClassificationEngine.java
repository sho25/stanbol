...
name|F1_FIELD
init|=
literal|"org.apache.stanbol.enhancer.engine.topic.f1Field"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
specifier|protected
name|EmbeddedSolrServer
name|makeTopicClassifierSolrServer
parameter_list|(
name|File
name|folder
parameter_list|)
...
condition|)
block|{
comment|// count positive success
block|}
else|else
block|{
comment|// collect false negatives
block|}
block|}
block|}
do|while
...
comment|// TODO: handle false positives with negative examples here
comment|// TODO: store performance statistics for current model in the original classifier
block|}
return|return
name|batch
operator|.

...
return|;
block|}
comment|/**      * @param topicId      *            the topic model to update      * @param impactedTopics      *            the list of impacted topics (e.g. the topic node and direct children)      * @param broaderTopics      *            the collection of broader to re-add in the broader field      */
specifier|public
name|void
name|updateTopic
parameter_list|(
...
condition|)
block|{
comment|// TODO: force UTC timezone here
name|doc
operator|.
name|addField
argument_list|(

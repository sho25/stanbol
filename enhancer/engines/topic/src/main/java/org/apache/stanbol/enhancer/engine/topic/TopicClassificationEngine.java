...
name|LANGUAGE
init|=
literal|"org.apache.stanbol.enhancer.engine.topic.language"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
comment|// The Solr server is expected to be configured with the MoreLikeThisQueryHandler and the matching
comment|// fields from the configuration.
name|solrServer
operator|=
operator|(
name|SolrServer
...
block|}
block|}
comment|// optional field, can be null
name|materializedPathField
operator|=
operator|(
name|String
...
argument_list|)
expr_stmt|;
comment|// TODO: express the results as RDF.
block|}
specifier|public
name|List
argument_list|<
...
comment|// for debugging / explanation in dedicated RDF datastucture.

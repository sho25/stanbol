...
specifier|public
name|void
name|testBatchTrainClassifierFromExamples
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// further update of the model leave do not change any topic but they are re-indexed anyway because
comment|// incremental update is disabled.
name|assertEquals
argument_list|(
literal|7
argument_list|,

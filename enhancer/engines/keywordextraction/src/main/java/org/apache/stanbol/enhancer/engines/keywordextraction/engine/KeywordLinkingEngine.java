...
argument_list|)
block|,
comment|//@Property(name=TaxonomyLinkingEngine2.SIMPLE_TOKENIZER,boolValue=true),
comment|//@Property(name=TaxonomyLinkingEngine2.ENABLE_CHUNKER,boolValue=false),
annotation|@
name|Property
argument_list|(
name|name
...
decl_stmt|;
comment|//  public static final String SIMPLE_TOKENIZER = "org.apache.stanbol.enhancer.engines.keywordextraction.simpleTokenizer";
...
block|}
block|}
comment|/**      * Extracts the text from the parsed contentItem. In case the content type is      * plain text, it directly reads the text from the stream. In other cases it      * tries to read the string representation from the metadata by looking for      * values of the {@link org.apache.stanbol.enhancer.servicesapi.rdf.Properties#NIE_PLAINTEXTCONTENT}      * property.<p>      * TODO: This is a Workaround for the currently not implemented Adapter      * Pattern for the Stanbol Enhancer.      * @param ci      * @param mimeType      * @return      * @throws InvalidContentException      */
specifier|private
name|String
name|extractText
parameter_list|(
...
comment|/**      * Activates this Engine. Subclasses should not call this method but rather      * call<ul>      *<li> {@link #activateEntitySearcher(ComponentContext, Dictionary)}      *<li> {@link #initEntityLinkerConfig(Dictionary, EntityLinkerConfig)} and      *<li> {@link #activateProcessedLanguages(Dictionary)}      *</ul>      * if applicable.      * @param context the Component context      * @throws ConfigurationException if the required {@link #REFERENCED_SITE_ID}      * configuration is missing or any of the other properties has an illegal value      */
annotation|@
name|Activate
annotation|@
...
argument_list|)
expr_stmt|;
name|activateProcessedLanguages
argument_list|(
name|properties
argument_list|)
expr_stmt|;
block|}
comment|/**      * Initialise the processed languages based on the value of the      * {@link #PROCESSED_LANGUAGES} key. If no configuration is present the      * default (process all languages) is used.      * @param configuration the OSGI component configuration      */
specifier|protected
specifier|final
name|void
name|activateProcessedLanguages
...
argument_list|()
expr_stmt|;
name|deactivateProcessedLanguages
argument_list|()
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**      * Sets the languages to {@link #DEFAULT_LANGUAGES}      */
specifier|protected
name|void
name|deactivateProcessedLanguages
parameter_list|()

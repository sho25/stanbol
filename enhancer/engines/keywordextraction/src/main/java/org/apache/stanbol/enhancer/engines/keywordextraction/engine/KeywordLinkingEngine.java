...
init|=
literal|"org.apache.stanbol.enhancer.engines.keywordextraction.dereferenceFields"
decl_stmt|;
...
expr_stmt|;
block|}
comment|//add the name of the ReferencedSite providing this suggestion
name|metadata
operator|.
name|add
argument_list|(
...
expr_stmt|;
block|}
comment|//nlpConfig.enablePosTypeChunker(false);
comment|//nlpConfig.enableChunker(false);
name|analysedContentFactory
operator|=
name|OpenNlpAnalysedContentFactory
operator|.

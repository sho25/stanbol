...
expr_stmt|;
block|}
comment|/**      * POS tags used by the Dutch POS model of OpenNLP for Dutch.<p>      * Source: J.T. Berghmans, "WOTAN: Een automatische grammatikale tagger       * voor het Nederlands", doctoral dissertation, Department of language&       * Speech, Nijmegen University (renamed to Radboud University),       * december 1994.<p>      *       */
specifier|public
specifier|static
specifier|final
name|TagSet
...
expr_stmt|;
block|}
comment|/**      * POS tags used by the Swedish POS model of OpenNLP for Swedish based on the      *<a href="http://w3.msi.vxu.se/users/nivre/research/MAMBAlex.html">      * Lexical categories in MAMBA</a>      */
specifier|public
specifier|static
specifier|final
name|TagSet

...
specifier|private
class|class
name|OntologyContentSourceWithPhysicalIRI
extends|extends
name|OntologyContentInputSource
block|{
specifier|public
...
name|error
argument_list|(
literal|"Cannot populate locked session '{}'. Aborting."
argument_list|,
name|session
operator|.
name|getID
...
name|error
argument_list|(
literal|"Failed to obtain ontology for entity "
operator|+
name|entityReference
operator|+
literal|". Skipping."
...
block|}
block|}
comment|// Now merge the RDF from the TBox - the ontologies - and the ABox - the RDF data fetched
specifier|final
name|OWLOntologyManager
name|omgr
init|=
...
block|}
decl_stmt|;
comment|/*          * We merge all the ontologies from the session into a single ontology that will be used for the          * refactoring.          *           * TODO the refactorer should have methods to accommodate OntologyCollector instead.          */
name|OWLOntologyMerger
name|merger
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|/*              * The session needs to be destroyed, as it is no more useful.              *               * clear contents before destroying (FIXME only do this until this is implemented in the              * destroySession() method).              */
for|for
control|(
name|IRI
name|iri
...
literal|null
decl_stmt|;
comment|// Ask the entityhub the fetch the entity.
name|Entity
name|entitySign
init|=
name|referencedSiteManager
...
literal|null
decl_stmt|;
comment|// The entity graph to be wrapped into an OWLOntology.
if|if
condition|(
name|entitySign
operator|!=
...
name|error
argument_list|(
literal|"Failed to add rules to recipe {}. Recipe was not found."
argument_list|,
name|recipeId
argument_list|)
expr_stmt|;

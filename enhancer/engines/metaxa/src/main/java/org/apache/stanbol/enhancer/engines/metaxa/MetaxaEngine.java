...
name|label
operator|=
literal|"Apache Stanbol Text and Metadata Extraction Engine"
argument_list|,
name|description
operator|=
literal|"Extract plain text and embedded metadata form various document types and formats"
argument_list|)
annotation|@
name|Service
specifier|public
...
name|label
operator|=
literal|"ExtractorRegistry"
argument_list|,
name|description
operator|=
literal|"The path of a resource on the bundle classpath that specifies which extractors to use."
argument_list|,
name|value
operator|=
...
name|description
operator|=
literal|"The path of a resource on the bundle classpath that specifies which extractors are used for HTML pages."
argument_list|)
specifier|public
specifier|static
specifier|final

...
argument_list|)
decl_stmt|;
comment|/**      * TODO: workaround for STANBOL-162      * This Reference is used to statically mark this Engine as to require       * {@link OnlineMode} until it can dynamically detect the mode based on the      * used ReferencedSite. See STANBOL-162 for details.      */
annotation|@
name|Reference
name|OnlineMode
name|offlineMode

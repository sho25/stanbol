...
argument_list|(
literal|"ServletContext is not NULL!"
argument_list|)
throw|;
block|}
if|if
...
name|IllegalStateException
argument_list|(
literal|"Clerezza RDF parser service is not available(service class:"
operator|+
name|Parser
operator|.
name|class
...
name|IllegalStateException
argument_list|(
literal|"ContentItemFactory service is not available (service class:"
operator|+
name|ContentItemFactory
operator|.
name|class

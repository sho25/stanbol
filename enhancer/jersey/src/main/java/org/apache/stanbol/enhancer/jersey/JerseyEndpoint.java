...
name|ALIAS_PROPERTY
init|=
literal|"org.apache.stanbol.enhancer.jersey.alias"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
init|=
literal|"org.apache.stanbol.enhancer.jersey.static.url"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
init|=
literal|"org.apache.stanbol.enhancer.jersey.static.classpath"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
init|=
literal|"org.apache.stanbol.enhancer.jersey.templates.classpath"
decl_stmt|;
annotation|@
name|Reference
name|TcManager
...
expr_stmt|;
block|}
comment|// forward the main Stanbol Enhancer OSGi components to the servlet context so that
...
specifier|protected
name|void
name|bindEnhancementJobManager
parameter_list|(
name|EnhancementJobManager
name|jobManager
parameter_list|)
...
specifier|protected
name|void
name|unbindEnhancementJobManager
parameter_list|(
name|EnhancementJobManager
name|jobManager
parameter_list|)

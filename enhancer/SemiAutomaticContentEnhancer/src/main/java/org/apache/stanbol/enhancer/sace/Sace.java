...
name|WINDOW_TITLE
init|=
literal|"Stanbol Enhancer - S.A.C.E"
decl_stmt|;
specifier|public
name|Sace
parameter_list|()
...
literal|null
argument_list|,
literal|"Please indicate the Stanbol Enhancer server URL"
argument_list|,
name|WINDOW_TITLE
argument_list|,
name|JOptionPane
...
parameter_list|)
block|{
comment|// get stuff from the Stanbol Enhancer
name|String
name|result
init|=
name|sendTextToStanbolEnhancer
argument_list|(
name|text
argument_list|)
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// transform Stanbol Enhancer annotations to SACE-annotations
return|return
...
name|equals
argument_list|(
literal|"http://enhancer.iks-project.eu/ontology/"
argument_list|)
condition|)
block|{
name|String

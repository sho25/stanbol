...
argument_list|)
expr_stmt|;
comment|//no path tracking support possible within functions
block|}
block|}
else|else
block|{
...
block|{
return|return
literal|"Wraps a Selector as a function. The first parameter can be used "
operator|+
literal|"to parse context(s) to execute the wraped selector on. If no arguments "
operator|+
literal|"are parsed the current context is used."
return|;
block|}
block|}
end_class

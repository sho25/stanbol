...
condition|)
block|{
comment|//no contexts parsed os first param ... use the current context
name|contexts
operator|=
name|Collections
operator|.
...
name|warn
argument_list|(
literal|"Unable to parse parameter 'limit' form the {}nd argument '{}'"
argument_list|,
name|index
argument_list|,
name|value
...
name|name
operator|+
literal|"([{context},]{limit},{missing-confidence-mode})"
return|;
block|}
annotation|@
name|Override
...
block|{
return|return
literal|"Function that retrieves EntitySuggestions for TextAnnotations (sorted by highest confidence first)"
return|;
block|}
block|}
end_class

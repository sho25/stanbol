...
argument_list|()
return|;
comment|//empty context -> empty result
block|}
elseif|else
if|if
condition|(
...
index|]
expr_stmt|;
comment|//param[0] contains references -> use this as context
name|paramOffset
operator|=
literal|1
expr_stmt|;
comment|//start parsing parameters at position 1
block|}
else|else
block|{
comment|//literal parameter at param index 0 ->
name|contexts
operator|=
name|Collections
operator|.
...
literal|0
expr_stmt|;
comment|//start parsing parameters at position 0
block|}
name|Integer
name|limit
init|=

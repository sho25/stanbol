...
block|}
block|}
comment|/**      * Extracts the EnhancementProperty value from the parsed Resource.<p>      * Currently this will return {@link UriRef#getUnicodeString()} or      * {@link Literal#getLexicalForm()}. For {@link BNode}s<code>null</code>       * is returned.      * @param r the resource to parse the value form      * @return the parsed value      */
specifier|private
specifier|static
name|Object
name|extractEnhancementPropertyValue
...
name|constructor
init|=
name|getConstigTypeConstructor
argument_list|(
name|type
argument_list|)
decl_stmt|;
...
begin_comment
comment|/**      * Internally used to get the config value for the parsed value and type.      * @param value      * @param type      * @param constructor the constructor typically retrieved by calling      * {@link #getConstigTypeConstructor(Class)} for the type      * @return the value      */
end_comment

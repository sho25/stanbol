...
argument_list|()
operator|+
literal|") is not compatiple to the requested"
operator|+
literal|"type "
operator|+
name|clazz
...
name|IllegalArgumentException
argument_list|(
literal|"The parsed index MUST NOT be< 0"
argument_list|)
throw|;
block|}
if|if
...
argument_list|(
literal|"The main ContentPart (index == 0) CAN NOT be removed!"
argument_list|)
throw|;
block|}
name|writeLock
...
name|IllegalArgumentException
argument_list|(
literal|"The parsed uriRef MUST NOT be NULL!"
argument_list|)
throw|;
block|}
name|writeLock
...
name|IllegalStateException
argument_list|(
literal|"The main ContentPart (uri '"
operator|+
name|uriRef
operator|+

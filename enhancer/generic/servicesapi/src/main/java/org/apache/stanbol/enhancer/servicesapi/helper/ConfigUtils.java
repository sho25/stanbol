...
return|;
block|}
comment|/**      * Returns the "key, parameter" entry parsed form the parsed configuration       * line.<p>      * This method is useful if the caller need to preserve the oder of multi      * line configurations and therefore can not use the parseConfig methods.      * @param line a configuration line      * @return the key, parameter entry      */
specifier|public
specifier|static
name|Entry
argument_list|<
...
return|;
block|}
comment|/**      * Utility that extracts enhancement properties from the parsed parameter maps.      * This will only consider keys starting with '<code>enhancer.</code>' as      * defined by<a href="https://issues.apache.org/jira/browse/STANBOL-488">STANBOL-488</a>      * @param parameters the paraemters (e.g. as returned as values by      * {@link #parseConfig(Iterator)})      * @return The enhancement properties extracted from the parsed parameters      * @since 0.12.1      */
specifier|public
specifier|static
name|Map
argument_list|<
...
return|;
block|}
comment|/**      * Utility that extracts enhancement properties from a configuration line      * using the syntax      *<pre>      *     {prop}={value-1},{value-2},..,{value-n}      *</pre>      * @param line the configuration of a single enhancement property      * @return The enhancement properties extracted from the parsed parameters      * @since 0.12.1      */
specifier|public
specifier|static
name|Map
argument_list|<

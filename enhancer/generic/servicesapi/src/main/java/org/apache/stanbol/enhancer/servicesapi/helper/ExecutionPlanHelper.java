...
return|;
block|}
comment|/**      * Creates an ExecutionPlan for the parsed chainName in the parsed Graph      * @param graph the graph      * @param chainName the chain name      * @return the node representing the ex:ExecutionPlan      */
specifier|public
specifier|static
name|NonLiteral
...
return|;
block|}
comment|/**      * Creates an execution plan based on the       * {@link ServiceProperties#ENHANCEMENT_ENGINE_ORDERING} of the parsed      * EnhancementEngines. NOTE that the parsed list is modified as it is sroted by      * using the {@link EnhancementEngineHelper#EXECUTION_ORDER_COMPARATOR}.<p>      * A second parameter with the set of optional engines can be used to define      * what {@link ExecutionPlan#EXECUTION_NODE} in the execution plan should be       * marked as {@link ExecutionPlan#OPTIONAL}.      * @param chainName the name of the Chain to build the execution plan for      * @param availableEngines the list of engines      * @param the names of optional engines.      * @return the execution plan      */
specifier|public
specifier|static
name|Graph

...
argument_list|)
decl_stmt|;
comment|/**      * Getter for the EnhancementProperties content part      * @param ci the content item      * @return the content part or<code>null</code> if not present.      */
annotation|@
...
block|}
block|}
comment|/**      * Initialises the EnhancementProperties ContentPart for an {@link ContentItem}.      * If the content part is already present it will just return the existing. If      * not it will register an empty one. The content part is registered with      * the URI {@link #ENHANCEMENT_PROPERTIES_URI}      * @param ci the contentItem MUST NOT be NULL      * @return the enhancement properties      * @throws IllegalArgumentException if<code>null</code> is parsed as {@link ContentItem}.      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"

...
decl_stmt|;
comment|//    /**
comment|//     * Creates a new POS tag for the parsed tag. The created Tag is not
comment|//     * assigned to any {@link LexicalCategory}.<p> This constructor can be used
comment|//     * by {@link EnhancementEngine}s that encounter an Tag they do not know
comment|//     * (e.g. that is not defined by the configured {@link TagSet}).<p>
comment|//     * @param tag the Tag
comment|//     * @throws IllegalArgumentException if the parsed tag is<code>null</code>
comment|//     * or empty.
comment|//     */
comment|//    public PosTag(String tag){
comment|//        this(tag,(LexicalCategory)null);
comment|//    }
...
block|{
comment|// in case of multiple Pos Tags
name|this
operator|.
name|pos
operator|=
...
argument_list|)
expr_stmt|;
comment|//we need to collect categories
name|this
operator|.
name|category
operator|=
...
argument_list|(
literal|"furtherPos parameter MUST BE NULL "
operator|+
literal|"or empty if the pos parameter is NULL!"
argument_list|)
throw|;
block|}
name|this

...
parameter_list|()
block|{
comment|//TODO: if mentions can be modified you can not use Collections.emptySet
comment|//      because this would cause exceptions in #addMention or if users
comment|//      to #getMentions().remove(...)
comment|//IMHO mentions should be made immutable by using a
comment|//Collections.unmodifiableSet(..) for the field and removing the
comment|//#addMentions(..) method.
name|this
argument_list|(
literal|null
argument_list|,
...
expr_stmt|;
block|}
comment|/** 	 * Getter whether the {@link Token} to which this tag is attached is the      * representative metion in the chain. 	 * @return the representative state 	 */
specifier|public
name|boolean
name|isRepresentative
parameter_list|()

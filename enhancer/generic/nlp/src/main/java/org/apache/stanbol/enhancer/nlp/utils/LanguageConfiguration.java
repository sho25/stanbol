...
return|;
block|}
comment|/**      * Returns parsed parameters if<code>{@link #isLanguage(String)} == true</code>      * @param language the language      * @return the parameters or<code>null</code> if none or the parsed language      * is not active.      */
specifier|public
name|Map
argument_list|<
name|String
...
operator|)
operator|&&
comment|//if no or empty parameters
operator|!
name|defaultParameters
operator|.
name|isEmpty
...
condition|)
block|{
comment|//and there are defaults
name|params
operator|=
name|defaultParameters
expr_stmt|;
...
block|}
block|}
comment|/**      * Returns the value of the parameter for the language (if present and the      * langage is active)      * @param language the language      * @param paramName the name of the param      * @return the param or<code>null</code> if not present OR the language      * is not active.      */
specifier|public
name|String
name|getParameter
parameter_list|(

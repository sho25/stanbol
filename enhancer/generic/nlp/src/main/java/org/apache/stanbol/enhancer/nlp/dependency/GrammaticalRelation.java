...
begin_comment
comment|/** 	 * The parent of this grammatical relation. 	 */
end_comment
...
begin_comment
comment|/** 	 * This is needed because one can not create EnumSet instances before the 	 * initialization of an Enum has finished. 	 *<p> 	 * To keep using the much faster {@link EnumSet} a static member initialised 	 * in an static {} block is used as a workaround. 	 */
end_comment

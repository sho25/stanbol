...
condition|)
block|{
comment|//FileNotFoundException is thrown in case of 404 NOT FOUND responses
name|log
operator|.
name|warn
argument_list|(
...
name|contains
argument_list|(
literal|"Server returned HTTP response code: 401"
argument_list|)
condition|)
block|{
name|log
...
name|warn
argument_list|(
literal|"deactivate Test because Server returned HTTP Error 401 Unauthorized (Message: '"
operator|+
name|check
operator|.
name|getMessage
...
name|contains
argument_list|(
literal|"Server returned HTTP response code: 402"
argument_list|)
condition|)
block|{
name|log
...
name|warn
argument_list|(
literal|"deactivate Test because Server returned HTTP Error 402 Payment Required (Message: '"
operator|+
name|check
operator|.
name|getMessage
...
name|warn
argument_list|(
literal|"deactivate Test because Server returned HTTP Error 403 Forbidden (Message: '"
operator|+
name|check
operator|.
name|getMessage

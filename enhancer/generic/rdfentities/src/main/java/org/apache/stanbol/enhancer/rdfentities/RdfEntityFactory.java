...
begin_comment
comment|/**  * A Factory that creates proxies over rdf nodes - so called RDF facades.  *  * @author Rupert Westenthaler  */
end_comment
...
block|{
comment|/**      * Creates a new factory for the parsed {@link Graph} instance.      *      * @param graph the graph used by the proxies created by this factory to      * read/write there data      * @return the created factory      */
specifier|public
specifier|static
name|RdfEntityFactory
name|createInstance

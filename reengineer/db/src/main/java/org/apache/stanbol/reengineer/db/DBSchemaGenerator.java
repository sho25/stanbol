...
expr_stmt|;
block|}
comment|/** 	 * Performs the generation of the RDF of the database schema. The RDF graph is added to the {@link MGraph} passed as input. 	 *   	 *  	 * @param mGraph {@link OWLOntology} 	 * @return the {@link MGraph} containing the database schema into RDF. 	 */
specifier|public
name|OWLOntology
name|getSchema
parameter_list|()

...
decl_stmt|;
comment|/*      * We need here a custom http client that uses a connection pool       */
specifier|protected
name|DefaultHttpClient
...
name|info
argument_list|(
literal|"Testing with Enhancement Chain '{}'"
argument_list|,
name|chain
argument_list|)
expr_stmt|;
...
block|{
comment|//else no chain configured ... use default
name|log
operator|.
name|info
argument_list|(
literal|"Testing default Enhancement Chain"
argument_list|)
expr_stmt|;
block|}
comment|//add the parameter for the execution metadata
name|this
operator|.
name|endpoint
operator|=

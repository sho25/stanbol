...
name|warn
argument_list|(
literal|"Unable to initialise NamespacePrefixService. '{prefix}:{localname}' type "
operator|+
literal|"will not be supported and cause IllegalArgumentExceptions when used!"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|" - TestDataIterator returned empty or NULL content (igonred)"
argument_list|)
expr_stmt|;
name|testNum
operator|--
...
name|info
argument_list|(
literal|"Unable to close HttpClient"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
literal|null
expr_stmt|;
comment|//do not store content for successful results
block|}
catch|catch
parameter_list|(
name|Exception

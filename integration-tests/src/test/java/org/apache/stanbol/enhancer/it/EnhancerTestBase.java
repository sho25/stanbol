...
block|}
block|}
comment|/**      * Setter for the endpoint. Keeps care of leading '/' and supports optional query parameter      * @param endpoint the endpoint or<code>null</code> to use the default      * @param params optional query parameter(s) [key,value,key,value,...]      */
specifier|protected
name|void
name|setEndpoint
parameter_list|(

...
name|expected
init|=
literal|"{\"@subject\":\"R1\",\"person\":\"http://upb.de/persons/bnagel\"}"
decl_stmt|;
name|String
name|actual
init|=
...
specifier|public
name|void
name|querySingleFactMultiResults
parameter_list|()
throws|throws
name|Exception
block|{
...
name|encodeURI
argument_list|(
literal|"http://iks-project.eu/ont/emplOf"
argument_list|)
argument_list|)
argument_list|)
argument_list|)
...
name|withContent
argument_list|(
literal|"{\"@context\":{\"iks\":\"http://iks-project.eu/ont/\",\"upb\":\"http://upb.de/persons/\"},\"@profile\":\"iks:emplOf\",\"person\":{\"@iri\":\"upb:jim\"},\"organization\":{\"@iri\":\"http://upb.de\"}}"
argument_list|)
operator|.
name|withHeader
argument_list|(
...
name|withContent
argument_list|(
literal|"{\"@context\":{\"iks\":\"http://iks-project.eu/ont/\",\"upb\":\"http://upb.de/persons/\"},\"@profile\":\"iks:emplOf\",\"person\":{\"@iri\":\"upb:john\"},\"organization\":{\"@iri\":\"http://upb.de\"}}"
argument_list|)
operator|.
name|withHeader
argument_list|(
...
name|withContent
argument_list|(
literal|"{\"@context\":{\"iks\":\"http://iks-project.eu/ont/\",\"upb\":\"http://upb.de/persons/\"},\"@profile\":\"iks:emplOf\",\"person\":{\"@iri\":\"upb:james\"},\"organization\":{\"@iri\":\"http://upb.de\"}}"
argument_list|)
operator|.
name|withHeader
argument_list|(
...
name|queryString
init|=
literal|"{\"@context\":{\"iks\":\"http://iks-project.eu/ont/\"},\"select\":[\"person\"],\"from\":\"iks:emplOf\",\"where\":[{\"=\":{\"organization\":{\"@iri\":\"http://upb.de\"}}}]}"
decl_stmt|;
name|Request
name|q
init|=
...
name|expected
init|=
literal|"{\"@subject\":[{\"@subject\":\"R1\",\"person\":\"http://upb.de/persons/jim\"},{\"@subject\":\"R2\",\"person\":\"http://upb.de/persons/john\"},{\"@subject\":\"R3\",\"person\":\"http://upb.de/persons/james\"}]}"
decl_stmt|;
name|String
name|actual
init|=

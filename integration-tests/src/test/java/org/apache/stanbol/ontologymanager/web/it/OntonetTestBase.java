...
begin_comment
comment|/**   * Inherit from this to wait for all to be up before running tests.  */
end_comment
...
name|fail
argument_list|(
literal|"Timeout in previous check of ontonet engine, cannot run tests"
argument_list|)
expr_stmt|;
block|}
specifier|final
...
name|info
argument_list|(
literal|"Ontonet checked, engine is ready."
argument_list|)
expr_stmt|;
return|return
literal|true
...
block|{
return|return
literal|"Checking that Ontonet engine is ready"
return|;
block|}
block|}
decl_stmt|;

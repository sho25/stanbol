...
comment|/*executor.execute(             builder.buildGetRequest(SCOPE2_URI)             .withHeader("Accept",KRFormat.RDF_XML)         ).assertStatus(200);*/
block|}
...
comment|/*executor.execute(             builder.buildGetRequest(ONTOLOGY_URI)         ).assertContentContains(SCOPE_BIZ_URI);          executor.execute(             builder.buildGetRequest(ONTOLOGY_URI+"?with-inactive=true")         ).assertContentContains(SCOPE_BIZ_URI);*/
comment|//log.info(executor.execute(builder.buildGetRequest(ONTOLOGY_URI)).getContent());
comment|//log.info(executor.execute(builder.buildGetRequest(ONTOLOGY_URI+"?with-inactive=true")).getContent());
block|}
specifier|private
name|String
name|encodeURI

...
begin_comment
comment|/**  * Defines commonly used name spaces to prevent multiple definitions in several classes.  *   * TODO: This class was directly adapted from the Entityhub services api. It would be better to have a common  * namespace enum throughout the Stanbol.  *   */
end_comment
...
name|cms
argument_list|(
literal|"http://www.apache.org/stanbol/cms#"
argument_list|)
block|,
...
argument_list|)
block|,
comment|// Entityhub prefers DC-Terms, therefore use the "dc" prefix
comment|// for the terms name space
name|foaf
argument_list|(

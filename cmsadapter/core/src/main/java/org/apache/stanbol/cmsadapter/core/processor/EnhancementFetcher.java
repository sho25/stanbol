...
begin_comment
comment|/**  * This processer can process CMS Objects of type {@link ContentObject}. If provided ContentObject has a  * property with name equal to configured property  *<b>org.apache.stanbol.cmsadapter.core.processor.EnhancementFetcher.contentProperty</b> then the content  * submitted to content hub, and the individual generated for ContentObject is related to enhancement graph  * with {@link CMSAdapterVocabulary#CMSAD_PROPERTY_CONTENT_ITEM_REF}  *   * @author cihan  *   */
end_comment
...
name|debug
argument_list|(
literal|"Added {} as content item ref to cms object with id {}"
argument_list|,
name|contentItemReference
argument_list|,
name|cmsObjectId
...
specifier|private
name|void
name|deleteContentItemRelation
parameter_list|(
name|String
name|cmsObjectId
parameter_list|,

...
condition|)
block|{
comment|// we couldn't obtain the short name from the property URI and skipping this property
name|log
operator|.
name|warn
argument_list|(
literal|"Failed to obtain short name for the propertyURI: {}. Skipping it..."
argument_list|,
name|propURI
argument_list|)
expr_stmt|;
...
block|{
comment|// TODO it's a better solution to makes possible to add new prefix-uri tuples to NamespaceEnum
name|log
operator|.
name|debug
argument_list|(
literal|"Auto generated URI is being assigned for namespace prefix: {}"
argument_list|,
name|prefix
argument_list|)
expr_stmt|;

...
argument_list|)
decl_stmt|;
comment|/**      * Tries to get a {@link Session} first through a {@link RMIRemoteRepository}. If the attempt is      * unsuccessful it tries {@link URLRemoteRepository}. If the second attempt is also unsuccessful, throws a      * {@link RepositoryAccessException}, otherwise returns a {@link Session} object.      *       * @param connectionInfo      * @return {@link Session} if it was able to get one      * @throws RepositoryAccessException      */
annotation|@
name|Override
specifier|public
name|Session
...
name|RepositoryAccessException
argument_list|(
literal|"Failed to get JCR Session"
argument_list|)
throw|;
block|}
block|}
...
name|debug
argument_list|(
literal|"Failed to get JCR session by URLRemoteRepository"
argument_list|)
expr_stmt|;
name|log
operator|.
...
name|RepositoryAccessException
argument_list|(
literal|"Failed to execute query results."
argument_list|,
name|e
argument_list|)
throw|;

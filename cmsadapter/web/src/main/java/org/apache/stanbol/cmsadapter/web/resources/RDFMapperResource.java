...
expr_stmt|;
block|}
comment|/**      * This service takes credentials as {@link ConnectionInfo} object to access repository and an RDF data      * first to be annotated and then stored in repository based on the annotations.      *       * @param connectionInfo      *            is the object that holds all necessary information to connect repository. Example connection      *            info XML:      *       *<pre>      *<font size="3">      *&lt;?xml version="1.0" encoding="UTF-8"?>      *&lt;connectionInfo      *     xmlns="web.model.servicesapi.cmsadapter.stanbol.apache.org">      *&lt;repositoryURL>rmi://localhost:1099/crx&lt;/repositoryURL>      *&lt;workspaceName>demo&lt;/workspaceName>      *&lt;username>admin&lt;/username>      *&lt;password>admin&lt;/password>      *&lt;connectionType>JCR&lt;/connectionType>      *&lt;/connectionInfo>      *</font>      *</pre>      * @param serializedGraph      *            is the serialized RDF graph that is desired to transformed into repository objects      */
comment|/*      * TODO: It would be wise to get as MGraph in request data. Before that connection info should be get in a      * different way.      */
annotation|@
name|Path
argument_list|(
literal|"/rdf"
...
return|;
block|}
comment|/**      * This service provides obtaining an RDF from the content repository based on the {@link RDFBridge}      * instances in the environment. Target content repository parts are determined according to path      * configurations of RDF Bridges.      *       * @param connectionInfo      *            is the object that holds all necessary information to connect repository. Example connection      *            info XML:      *       *<pre>      *<font size="3">      *&lt;?xml version="1.0" encoding="UTF-8"?>      *&lt;connectionInfo      *     xmlns="web.model.servicesapi.cmsadapter.stanbol.apache.org">      *&lt;repositoryURL>rmi://localhost:1099/crx&lt;/repositoryURL>      *&lt;workspaceName>demo&lt;/workspaceName>      *&lt;username>admin&lt;/username>      *&lt;password>admin&lt;/password>      *&lt;connectionType>JCR&lt;/connectionType>      *&lt;/connectionInfo>      *</font>      *</pre>      * @return generated {@link MGraph} wrapped in a {@link Response} in "application/rdf+xml" format      */
annotation|@
name|Path
argument_list|(
literal|"/cms"

...
name|ContenthubFeederException
argument_list|(
literal|"Failed to set a session for CMISContenthubFeeder"
argument_list|,
name|e
argument_list|)
throw|;
...
name|PROP_SESSION
argument_list|,
literal|"A valid CMIS Session or session key should be provided to activate this component."
argument_list|)
throw|;
block|}
if|if
...
name|warn
argument_list|(
literal|"Failed to obtain short name for URI: {}"
argument_list|,
name|predicate
argument_list|)
expr_stmt|;

...
expr_stmt|;
block|}
comment|// Log level may be set as 'debug'
name|log
operator|.
name|info
argument_list|(
...
name|format
argument_list|(
literal|"Created object: %s,  Object parent: %s"
argument_list|,
name|documentName
argument_list|,
name|parent
...
name|rdfDocumentPath
argument_list|,
name|createDocumentContentStream
argument_list|(
name|createdObject
argument_list|,
name|rdfDocumentName

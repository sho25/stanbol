...
operator|+
literal|"  ?enhancement fise:extracted-from ?content ."
operator|+
...
return|;
block|}
comment|/**      * Cool URI handler for the uploaded resource.      *      * @param localId the local id of the resource in the FISE store      * @param headers      * @return a redirection to either a browser view, the RDF metadata or the      *         raw binary content      */
annotation|@
name|GET
annotation|@
name|Path

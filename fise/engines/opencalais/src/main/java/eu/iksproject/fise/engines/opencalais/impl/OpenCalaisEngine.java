...
name|LICENSE_KEY
init|=
literal|"eu.iksproject.fise.engines.opencalais.license"
decl_stmt|;
annotation|@
name|Property
argument_list|(
...
name|CALAIS_URL_KEY
init|=
literal|"eu.iksproject.fise.engines.opencalais.url"
decl_stmt|;
...
name|warn
argument_list|(
literal|"Wrong language for Calais: {}"
argument_list|,
name|language
argument_list|)
expr_stmt|;
...
block|{
comment|// TODO: check whether the metadata graph contains the text
name|Iterator
argument_list|<
name|Triple
argument_list|>

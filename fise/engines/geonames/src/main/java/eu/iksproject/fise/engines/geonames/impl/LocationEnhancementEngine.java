...
init|=
literal|"eu.iksproject.fise.engines.geonames.locationEnhancementEngine.serverURL"
decl_stmt|;
annotation|@
name|Property
specifier|public
...
init|=
literal|"eu.iksproject.fise.engines.geonames.locationEnhancementEngine.username"
decl_stmt|;
annotation|@
name|Property
specifier|public
...
name|GEONAMES_TOKEN
init|=
literal|"eu.iksproject.fise.engines.geonames.locationEnhancementEngine.token"
decl_stmt|;
...
literal|null
expr_stmt|;
comment|//prevent empty serverURLs (e.g. if the user deletes an value)
block|}
name|String
name|userName
init|=

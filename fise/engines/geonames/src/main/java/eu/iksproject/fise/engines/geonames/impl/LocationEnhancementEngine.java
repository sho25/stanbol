...
init|=
literal|"eu.iksproject.fise.engines.geonames.locationEnhancementEngine.min-hierarchy-score"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
name|warn
argument_list|(
literal|"Unable to parse MIN_SCORE"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Unable to parse MAX_LOCATION_ENHANCEMENTS"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Unable to parse MIN_HIERARCHY_SCORE"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
comment|//      than we need to parse the name based on the fise:entity-name property
block|}
block|}
...
argument_list|(
literal|"Change style of this implementation to get the score values"
argument_list|,
name|e
argument_list|)
throw|;
...
parameter_list|)
block|{
comment|//ignore -> don not write the score
block|}
...
argument_list|)
expr_stmt|;
comment|// criteria.setLanguage("language") TODO: search for the language of the document!
return|return
name|WebService
operator|.
name|search

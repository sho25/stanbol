...
init|=
literal|"eu.iksproject.fise.engines.zemanta.key"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
argument_list|)
expr_stmt|;
comment|//now we need to process the results and convert them into the FISE
...
condition|)
block|{
comment|//now write the FISE entity enhancement
name|UriRef
...
block|}
block|}
comment|/** 	 * Processes all Zemanta Recognitions and converts them to the according 	 * FISE enhancements 	 * @param results the results of the Zemanta enhancement process 	 * @param enhancements the graph containing the current FISE enhancements 	 * @param text the content of the content item as string 	 */
specifier|protected
name|void
name|processRecognition
parameter_list|(

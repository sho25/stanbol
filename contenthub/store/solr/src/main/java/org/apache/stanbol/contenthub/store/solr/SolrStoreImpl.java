...
specifier|private
name|String
name|addSolrDynamicFieldExtension
parameter_list|(
name|String
name|fieldName
parameter_list|,
...
name|StoreException
argument_list|(
literal|"There is no textual for the content item"
argument_list|)
throw|;
block|}
name|content
...
specifier|private
name|boolean
name|fieldAlreadyIndexedInProgram
parameter_list|(
name|String
name|programName
parameter_list|,
...
name|error
argument_list|(
literal|"Cannot execute the ldPathProgram on SolrContentItem's metadata"
argument_list|,
name|e
argument_list|)
expr_stmt|;

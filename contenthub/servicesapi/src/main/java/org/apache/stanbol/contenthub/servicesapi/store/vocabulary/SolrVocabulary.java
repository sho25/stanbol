...
argument_list|)
expr_stmt|;
comment|//        excludedFields.add(SolrFieldName.TITLE.toString());
comment|//        excludedFields.add("text_all");
block|}
comment|/**      * Checks whether the specified field is range field or not i.e whether the field will be used in range      * queries or not      *       * @param name      *            field name      */
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**      * Fields that will be used in range queries and will not be escaped in {@link SolrSearchEngineHelper}      * class      */
specifier|private
specifier|static
name|List
argument_list|<

...
name|error
argument_list|(
literal|"Missing 'index' parameter"
argument_list|)
expr_stmt|;
throw|throw
operator|new
...
name|error
argument_list|(
literal|"Missing SolrStore service"
argument_list|)
expr_stmt|;
throw|throw
operator|new
...
name|error
argument_list|(
literal|"Missing SolrSearch service"
argument_list|)
expr_stmt|;
throw|throw
operator|new
...
name|error
argument_list|(
literal|"Missing TcManager service"
argument_list|)
expr_stmt|;
throw|throw
operator|new
...
comment|/**      * Cool URI handler for the uploaded resource. Based on the Accept header this service redirects the      * incoming request to different endpoints in the following way:      *<ul>      *<li>If the Accept header contains the "text/html" value it is the request is redirected to the      *<b>page</b> endpoint so that an HTML document corresponding to the ContentItem is drawn.</li>      *<li>If the Accept header one of the RDF serialization formats defined {@link SupportedFormat}      * annotation, the request is redirected to the<b>metadata</b> endpoint and metadata of the specified      * {@link ContentItem} is returned.</li>      *<li>If the previous two conditions are not satisfied the request is redirected to the<b>raw</b>      * endpoint and raw content of the specified {@link ContentItem} is returned.</li>      *</ul>      *       * @param uri      *            The URI of the resource in the Stanbol Contenthub store      * @param headers      *            HTTP headers      * @return a redirection to either a browser view, the RDF metadata or the raw binary content      */
annotation|@
name|GET
annotation|@
name|Path
...
specifier|public
name|Response
name|createContentItemWithRawData
parameter_list|(
name|byte
index|[]
name|data
...
return|;
block|}
comment|/**      * This method deletes the {@link ContentItem} specified by the given {@link QueryParam}.      *       * @param uri      *            URI of the {@link ContentItem} to be deleted.      * @param headers      * @return {@link Response#ok()} if the removal is successful      * @throws StoreException      */
annotation|@
name|DELETE
specifier|public
name|Response
name|deleteContentItemByForm
parameter_list|(
annotation|@
name|QueryParam
argument_list|(

...
name|error
argument_list|(
literal|"Missing either store={} or tcManager={}"
argument_list|,
name|store
argument_list|,
name|tcManager
...
name|pageSize
expr_stmt|;
comment|// compute the latest: todo move some of this as OSGi parameters
comment|// somewhere
name|String
name|q
init|=
...
parameter_list|)
block|{
comment|// TODO: factorize this logic out in a dedicated OSGi service
return|return
name|ContentItemHelper
operator|.
name|makeDefaultUri
...
specifier|public
name|Response
name|createContentItemFromFomr
parameter_list|(
annotation|@
name|FormDataParam
argument_list|(
...
return|;
block|}
comment|// Consuming both APPLICATION_FORM_URLENCODED and MULTIPART_FORM_DATA does no
comment|// longer work with jersey (version> 1.2). See the public variants that are
comment|// calling this (now private) method
comment|//    @POST
comment|//    @Consumes( { APPLICATION_FORM_URLENCODED + ";qs=1.0",
comment|//            MULTIPART_FORM_DATA + ";qs=0.9" })
specifier|private
name|Response
name|createContentItemFromForm
parameter_list|(

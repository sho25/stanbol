...
parameter_list|()
function_decl|;
comment|/**      * Source is the name of the engine that creates this keyword      *       * @return returns the spring representation of the engine name      */
name|String
name|getSource
parameter_list|()
function_decl|;
comment|/**      * Source is the name of the engine that creates this keyword      *       * @param source      *            A {@link String} which defines the relevance the related keyword with the query keyword      */
name|void
name|setSource
parameter_list|(
name|String
...
parameter_list|)
function_decl|;
comment|/**      * Override of Object.toString() method      *       * @return the local name of the keywords resource      */
annotation|@
name|Override
name|String
name|toString

...
block|}
block|}
comment|/*      * public List<Keyword> getScoredWordnetResources(String[] keywordList, double maxScore, double      * degradingFactor, int expansionLevel) throws WordNetException { List<Keyword> returnList = new      * ArrayList<Keyword>(); for (String keyword : keywordList) {      * returnList.addAll(getScoredWordnetResources(keyword, maxScore, degradingFactor, expansionLevel)); }      * return returnList; }      */
specifier|public
specifier|final
name|List
argument_list|<

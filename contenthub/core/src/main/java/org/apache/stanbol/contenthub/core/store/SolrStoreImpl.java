...
name|error
argument_list|(
literal|"SolrDirectoryManager could not be obtained so could not connect to the Embedded Solr Instance"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|debug
argument_list|(
literal|"Should never reach here: SolrStoreImpl.getEnhancementGraph()"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// Delete old enhancements which belong to this content item.
name|EnhancementLARQ
operator|.
name|getInstance
argument_list|()

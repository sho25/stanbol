...
name|name
operator|=
literal|"IndividualsForOntology"
argument_list|)
specifier|public
class|class
...
expr_stmt|;
block|}
comment|/**      * Gets the value of the individualMetaInformation property.      *       *<p>      * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification      * you make to the returned list will be present inside the JAXB object. This is why there is not a      *<CODE>set</CODE> method for the individualMetaInformation property.      *       *<p>      * For example, to add a new item, do as follows:      *       *<pre>      * getIndividualMetaInformation().add(newItem);      *</pre>      *       *       *<p>      * Objects of the following type(s) are allowed in the list {@link IndividualMetaInformation }      *       *       */
specifier|public
name|List
argument_list|<
name|IndividualMetaInformation

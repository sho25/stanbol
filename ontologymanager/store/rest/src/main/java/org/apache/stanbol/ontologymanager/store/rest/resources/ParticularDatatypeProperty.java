...
name|Path
argument_list|(
literal|"/ontologies/{ontologyPath:.+}/datatypeProperties/{datatypePropertyPath:.+}"
argument_list|)
annotation|@
name|ImplicitProduces
argument_list|(
...
name|VIEWABLE_PATH
init|=
literal|"/org/apache/stanbol/ontologymanager/store/rest/resources/particularDatatypeProperty"
decl_stmt|;
specifier|private
name|PersistenceStore
name|persistenceStore
...
specifier|public
name|Response
name|retrieveDatatypePropertyContext
parameter_list|(
annotation|@
name|PathParam
argument_list|(
...
return|;
block|}
comment|// FIXME Handle PS errors properly and return correct responses
...
name|datatypePropertyPath
argument_list|,
comment|/*                                                                                                  * domainURIs,                                                                                                  * rangeURIs,                                                                                                  * subPropertyOf                                                                                                  * ,                                                                                                  */
name|isFunctional
argument_list|)
operator|.
name|getEntity

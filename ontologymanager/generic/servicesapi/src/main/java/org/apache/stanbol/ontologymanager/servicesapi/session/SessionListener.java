...
parameter_list|)
function_decl|;
comment|/**      * Called whenever a scope is detached from a session.      *       * @param session      *            the affected session      * @param scopeId      *            the identifier of the scope that was attached. Note that the corresponding      *            {@link Scope} could be null if detachment occurred as a consequence of a scope      *            deletion.      * */
name|void
name|scopeDetached
parameter_list|(
name|Session

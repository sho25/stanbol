...
parameter_list|)
function_decl|;
comment|/**      * Returns the graph that stores all the information on stored ontologies. Whether the returned triple      * collection is a {@link ImmutableGraph} or a {@link Graph} depends on the provider's policy on allowing external      * modifications to the meta-level graph or not.      *       * @param returnType      * @return      */
parameter_list|<
name|O
extends|extends
name|Graph
...
parameter_list|()
function_decl|;
comment|/**      * XXX This method is temporary until {@link Multiplexer} becomes an OSGi component.      *       * @return      */
name|Multiplexer
...
parameter_list|)
function_decl|;
comment|/**      * Gets the set of all the strings that can be used to access the ontologies stored by this provider.      *       * @deprecated Please use {@link #listPrimaryKeys()} instead.      *       * @return the ontology key set.      */
name|Set
argument_list|<
name|OWLOntologyID
argument_list|>
...
parameter_list|)
function_decl|;
comment|/**      * Tells this ontology provider that a stored ontology whose public key is<tt>publicKey</tt> can be (or      * was) retrieved by dereferencing<tt>locator</tt>. If<tt>publicKey</tt>does not exist in the provider,      * or if<tt>locator</tt> is already bound to an incompatible key, an {@link IllegalArgumentException}      * will be thrown.      *       * @deprecated this is now done by setting aliases. See {@link #addAlias(OWLOntologyID, OWLOntologyID)}.      *       * @param locator      *            a physical location for this ontology.      * @param publicKey      *            the public key of the stored ontology.      */
name|void
...
parameter_list|)
function_decl|;
comment|/**      * @deprecated this is now done by setting aliases. See {@link #addAlias(OWLOntologyID, OWLOntologyID)}.      *       * @param locator      * @param key      */
name|void
name|setLocatorMapping
parameter_list|(
name|IRI

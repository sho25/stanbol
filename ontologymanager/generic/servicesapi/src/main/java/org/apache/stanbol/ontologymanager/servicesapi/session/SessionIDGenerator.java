...
begin_comment
comment|/**  * Implementations of this interface provide algorithms for generating valid  * identifiers for KReS sessions. These algorithms should take into account the  * need for excluding existing session IDs.  *   * @author alexdma  *   */
end_comment

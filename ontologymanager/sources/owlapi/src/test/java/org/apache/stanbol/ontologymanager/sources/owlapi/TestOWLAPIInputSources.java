...
begin_comment
comment|/**  * Test suite for the correctness of {@link OntologyInputSource} implementations based on the OWL API.  *   * @author alexdma  *   */
end_comment
...
argument_list|)
expr_stmt|;
comment|// Not knowing how the foaf:knows assertion is interpreted, we check for either (but not both!).
name|ax
operator|=
name|df
operator|.
...
comment|// Set<OWLOntology> closure = coreSource.getImports(true);
comment|// for (OWLOntology o : closure)
comment|// assertEquals("file", o.getOWLOntologyManager().getOntologyDocumentIRI(o).getScheme());
name|assertEquals
argument_list|(
name|coreSource
operator|.

...
name|OntologyLoadingException
argument_list|(
literal|"No suitable format defined."
argument_list|)
throw|;
comment|// If the first attempt failed, try all other formats if the streams allows it.
if|if
condition|(
operator|!
name|loaded
...
name|OntologyLoadingException
argument_list|(
literal|"First parsing attempt failed and data stream cannot be reset. Giving up."
argument_list|)
throw|;
block|}
if|if

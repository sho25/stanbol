...
argument_list|(
literal|"This ontology collector implementation cannot handle "
operator|+
name|o
operator|.
name|getClass
...
argument_list|)
throw|;
comment|// Null id? use the origin trick
if|if
condition|(
name|id
operator|==
...
name|warn
argument_list|(
literal|"Entering deprecated code block. Should not happen."
argument_list|)
expr_stmt|;
name|log
operator|.
...
argument_list|)
expr_stmt|;
comment|// // Always add sanitized version
comment|// managedOntologies.add(id.getVersionIRI() == null ? new OWLOntologyID(URIUtils.sanitizeID(id
comment|// .getOntologyIRI())) : new OWLOntologyID(URIUtils.sanitizeID(id.getOntologyIRI()),
comment|// URIUtils.sanitizeID(id.getVersionIRI())));
...
expr_stmt|;
block|}
comment|/**      * FIXME use dynamic prefix?      *       * @param ontology      */
specifier|protected
name|void
name|claimOwnership
parameter_list|(
...
name|UriRef
argument_list|(
literal|"http://www.w3.org/2002/07/owl#versionIRI"
argument_list|)
decl_stmt|;
name|UriRef
name|ontologyId
...
name|info
argument_list|(
literal|"    Found OWL version IRI {} . Will not claim ownership. "
argument_list|,
name|versionIri
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"    No OWL version IRI Found . Will set to own ID. "
argument_list|)
expr_stmt|;
name|Triple
name|t
...
control|)
block|{
comment|// TODO some day the versionIRI will be the only physical reference for the ontology
name|IRI
name|physIRI
init|=
comment|// ontologyId.getVersionIRI() == null ? URIUtils.sanitize(IRI
...
name|OWLOntologyID
argument_list|(
comment|/*                                                                                              * URIUtils.sanitizeID                                                                                              * (ontologyIri/*)                                                                                              */
argument_list|)
argument_list|)
return|;
block|}

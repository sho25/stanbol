...
name|scopeRegistry
decl_stmt|;
comment|/* 	 *  	 * The local ClerezzaOntologyStorage has been changed with the global Stanbol component 	 * PersistenceStore. 	 *  	 */
...
control|)
block|{
comment|/* 				 * As the store saves ontology as string serializations first it is needed to convert the ontology content 				 * to a string (the UTF-8 charset is used) and then it is possible to save the ontology specifying to the storage 				 * the ontology ID. 				 */
name|ByteArrayOutputStream
name|outStream
init|=
operator|new

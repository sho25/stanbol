...
block|{
comment|/* 					 * If the persistence store is not null then the ontology can be saved in the storage. 					 * As the store saves ontology as string serializations first it is needed to convert the ontology content 					 * to a string (the UTF-8 charset is used) and then it is possible to save the ontology specifying to the storage 					 * the ontology ID. 					 */
name|ByteArrayOutputStream
name|out
init|=
operator|new
...
block|{
comment|/* 					 * If the persistence store is not null then the root ontology can be saved in the storage. 					 * As the store saves ontology as string serializations first it is needed to convert the ontology content 					 * to a string (the UTF-8 charset is used) and then it is possible to save the ontology specifying to the storage 					 * the ontology ID. 					 */
name|ByteArrayOutputStream
name|out
init|=
operator|new

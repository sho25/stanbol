...
begin_comment
comment|/**  * An input source that provides a single ontology that imports all the imported ontology libraries found in  * the ontology registry obtained by dereferencing a supplied IRI.  *   */
end_comment
...
expr_stmt|;
block|}
comment|/*      * (non-Javadoc)      *       * @see org.apache.stanbol.ontologymanager.ontonet.api.io.AbstractOntologyInputSource#toString()      */
annotation|@
name|Override
specifier|public
name|String

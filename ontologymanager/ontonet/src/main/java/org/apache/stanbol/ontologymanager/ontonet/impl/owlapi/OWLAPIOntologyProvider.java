...
name|IllegalArgumentException
argument_list|(
literal|"The OWL API implementation does not support import policies other than PRESERVE."
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"The OWL API implementation does not use a graph for storing correspondencies"
argument_list|)
throw|;
block|}
annotation|@

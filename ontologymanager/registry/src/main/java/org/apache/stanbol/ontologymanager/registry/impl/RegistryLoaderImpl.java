...
name|error
argument_list|(
literal|"Cannot load ODP registry: "
operator|+
name|regs
index|[
name|i
...
name|error
argument_list|(
literal|"RegistryContentException caught while getting tree for "
operator|+
name|i
operator|.
name|getIRI
...
argument_list|)
decl_stmt|;
comment|// registry = onm.getRegistryManager().populateRegistry(ontology);
name|registry
operator|=
name|regmgr
operator|.

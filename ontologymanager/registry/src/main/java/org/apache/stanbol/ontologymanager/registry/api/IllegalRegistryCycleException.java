...
begin_comment
comment|/**  * Thrown when an attempt to create an illegal cycle in the registry item model is detected. Examples of  * illegal cycles include being both a parent and a child of the same registry item, or a parent or child of  * itself, or a library being a child of an ontology.  *   * @author alexdma  */
end_comment

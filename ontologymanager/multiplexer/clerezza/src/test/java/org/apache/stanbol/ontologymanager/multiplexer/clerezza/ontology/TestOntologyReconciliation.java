...
block|}
comment|/*      * If an anonymous ontology is loaded from a stream and at least one override is provided, the first      * override should be the primary key, while every other override should be an alias for that key.      */
annotation|@
name|Test
specifier|public
name|void
name|anonymousFromStreamWithCustomKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
operator|+
literal|"#anonymousFromStreamWithCustomKeys()"
argument_list|)
argument_list|)
decl_stmt|;
name|OWLOntologyID
...
argument_list|()
operator|+
literal|"#anonymousFromStreamWithCustomKeys().alias"
argument_list|)
argument_list|)
decl_stmt|;
name|InputStream
...
name|info
argument_list|(
literal|"Anonymous ontology loaded with non-anonymous public key {} (submitted)"
argument_list|,
name|key
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Named alias detected {}"
argument_list|,
name|al
argument_list|)
expr_stmt|;
block|}
comment|// Now retrieve using the alias
name|OWLOntology
name|o2
init|=
name|ontologyProvider
...
comment|// Cannot equal OWLOntology objects
block|}
comment|/*      * If an anonymous ontology is loaded from a URL and at least one override is provided, the first override      * should be the primary key, while everything else, including the URL, should be an alias for that key.      */
annotation|@
name|Test
specifier|public
name|void
name|anonymousFromURLWithCustomKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
operator|+
literal|"#anonymousFromURLWithCustomKeys()"
argument_list|)
argument_list|)
decl_stmt|;
name|OWLOntologyID
...
argument_list|()
operator|+
literal|"#anonymousFromURLWithCustomKeys().alias"
argument_list|)
argument_list|)
decl_stmt|;
name|URL
...
argument_list|)
expr_stmt|;
comment|// should have 2 aliases: the physical location and the submitted alias.
name|assertEquals
argument_list|(
literal|2
argument_list|,
...
expr_stmt|;
comment|// Cannot equal OWLOntology objects
comment|// ... and using the physical IRI
name|o2
operator|=
name|ontologyProvider
operator|.

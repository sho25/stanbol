...
name|arg0
decl_stmt|;
comment|//        return this.getID().equals(sc.getID())&& this.getDefaultNamespace().equals(sc.getDefaultNamespace())
comment|//&& this.getCoreSpace().equals(sc.getCoreSpace())
comment|//&& this.getCustomSpace().equals(sc.getCustomSpace());
if|if
condition|(
operator|!
name|this
...
throw|;
block|}
comment|/**      * Get a Clerezza {@link Graph} representation of the scope.      *       * @param merge      *            if true the core and custom spaces will be recursively merged with the scope graph,      *            otherwise owl:imports statements will be added.      * @return the RDF representation of the scope as a modifiable graph.      */
specifier|protected
name|Graph
name|exportToGraph
parameter_list|(

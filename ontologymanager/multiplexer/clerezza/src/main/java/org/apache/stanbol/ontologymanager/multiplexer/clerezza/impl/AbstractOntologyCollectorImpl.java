...
comment|// if (ontologyProvider.hasOntology(id.getOntologyIRI())) if (o instanceof Graph)
comment|// claimOwnership((Graph) o);
...
condition|)
block|{}
comment|// We don't know of other Graph subclasses: just try to cast the Graph.
return|return
operator|(
name|O
operator|)

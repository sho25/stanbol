...
annotation|@
name|Reference
comment|// (cardinality = ReferenceCardinality.MANDATORY_UNARY, policy = ReferencePolicy.DYNAMIC, bind =
comment|// "bindScopeManager", unbind = "unbindScopeManager", strategy = ReferenceStrategy.EVENT)
specifier|private
name|ScopeRegistry
name|scopeRegistry
decl_stmt|;

...
argument_list|(
literal|"Tried to obtain a multiplexer before an ontology provider was ready. This shouldn't happen."
argument_list|)
throw|;
name|descriptor
operator|=
...
parameter_list|)
block|{
comment|// TODO use rdfViewable instead of Viewable to make separation of
...
comment|// resource-intensive IndexedGraph, since both o and oTemp will be GC'ed after serialization.
if|if
condition|(
name|oTemp
operator|!=
...
name|debug
argument_list|(
literal|"Exported as Clerezza ImmutableGraph in {} ms. Handing over to writer."
argument_list|,
name|System
operator|.
name|currentTimeMillis
...
argument_list|)
expr_stmt|;
comment|// TODO be selective: if the ontology is small enough, use OWLOntology otherwise export to ImmutableGraph.
name|OWLOntology
name|o
init|=
literal|null
...
name|debug
argument_list|(
literal|" post(MultiPartBody data)"
argument_list|)
expr_stmt|;
name|ResponseBuilder
name|rb
...
name|html
init|=
literal|"<h1>400 Bad Request</h1>"
operator|+
literal|"<p>Failed to load ontology from<a href=\""
operator|+
name|location
operator|+
...
return|;
block|}
comment|// Assemble dependency list
name|Map
argument_list|<
name|OWLOntologyID
argument_list|,

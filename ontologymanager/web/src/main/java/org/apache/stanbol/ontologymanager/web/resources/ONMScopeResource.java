...
argument_list|)
expr_stmt|;
comment|// coreSrc = new RegistryIRISource(IRI.create(coreRegistry), onm.getOwlCacheManager(), loader);
block|}
catch|catch
parameter_list|(
name|Exception
...
argument_list|)
expr_stmt|;
comment|// custSrc = new RegistryIRISource(IRI.create(customRegistry), onm.getOwlCacheManager(),
comment|// loader);
block|}
catch|catch
parameter_list|(

...
block|}
block|}
comment|/**      * Getter for the Model used by this Representation<p>      * Note that this model might also contain triples with other subjects as      * the one used by this representation.      * @return the model used by this representation.      */
specifier|public
name|Model
name|getModel
parameter_list|()

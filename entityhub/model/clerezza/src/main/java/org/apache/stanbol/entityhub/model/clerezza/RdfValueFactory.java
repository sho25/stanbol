...
begin_comment
comment|/**  * Factory for creating instances of the RDF implementation of the Entityhub model  * based on Clerezza.  * TODO: Check if it makes sense to add a instance cache for {@link RdfReference}  *       instances.  * @author Rupert Westenthaler  *  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * This allows to create an instance that uses the same graph for all      * created {@link Representation}s. This allows to automatically add all      * data added to {@link Representation} created by this Factory to this      * graph.       * @param graph      */
specifier|public
name|RdfValueFactory
parameter_list|(
name|MGraph

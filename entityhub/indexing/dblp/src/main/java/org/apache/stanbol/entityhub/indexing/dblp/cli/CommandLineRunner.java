...
literal|"rdfs:seeAlso | d=entityhub:ref"
block|,
...
literal|"dc-elements:*"
block|,
comment|//to keep the "old" dc-element triples
literal|"dc-elements:contributor> dc:contributor"
block|,
literal|"dc-elements:coverage> dc:coverage"
block|,
literal|"dc-elements:creator> dc:creator"
block|,
literal|"dc-elements:date> dc:date"
block|,
literal|"dc-elements:description> dc:description"
block|,
literal|"dc-elements:format> dc:format"
block|,
literal|"dc-elements:identifier> dc:identifier"
block|,
literal|"dc-elements:language> dc:language"
block|,
literal|"dc-elements:publisher> dc:publisher"
block|,
literal|"dc-elements:relation> dc:relation"
block|,
literal|"dc-elements:rights> dc:rights"
block|,
literal|"dc-elements:source> dc:source"
block|,
literal|"dc-elements:subject> dc:subject"
block|,
literal|"dc-elements:title> dc:title"
block|,
literal|"dc-elements:type> dc:type"
block|,
...
literal|"foaf:knows | d=entityhub:ref"
block|,
literal|"foaf:made | d=entityhub:ref"
block|,
literal|"foaf:maker | d=entityhub:ref"
block|,
literal|"foaf:member | d=entityhub:ref"
block|,
...
comment|// --- The SWRC (Semantic Web for Research Communities) Ontology
literal|"swrc:*"
comment|//select all
block|}
decl_stmt|;
...
name|append
argument_list|(
literal|" - RDF dump: The relative or absolute path to the Rdf Dump or the Dir containing the source RDF files to be used for indexing. You can direcly use the compressed archives. In case you point to an Directory, all files in that directory are used to create the index\n"
argument_list|)
expr_stmt|;
name|builder
operator|.
...
literal|true
argument_list|,
literal|"the id and name used for the Yard (default: 'dblp')"
argument_list|)
expr_stmt|;
name|options
operator|.
...
expr_stmt|;
block|}
comment|//also allow to parse a single file!
comment|//        if(!dataDir.isDirectory()){
comment|//            log.error("Parsed Data Directory "+dataDir+" exists, but is not a Directory!");

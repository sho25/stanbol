...
literal|"score-pos"
decl_stmt|;
comment|/**      * If<code>true</code> ids are parsed to the {@link NamespacePrefixService}      * to convert '{prefix}:{localname}' like URIs to URIs. By default this is       * deactivated.</p>      * NOTE: that {@link #PARAM_ID_NAMESPACE} is applied first. Meaning that      * '{prefixes}' can be used for this parameter of this feature is enabled.      */
specifier|public
specifier|static
specifier|final
name|String
name|PARAM_NS_PREFIX_STATE
init|=
literal|"ns-prefix-state"
decl_stmt|;
...
name|nsPrefixState
decl_stmt|;
comment|/**      * Holds the prefix [0] and namespace [1] of the last encountered prefix      */
specifier|private
name|String
index|[]
name|lastNsPrefix
...
name|info
argument_list|(
literal|"Set Namespace Prefix State to {}"
operator|+
name|nsPrefixState
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|//this optimises for cases where all entities do start
comment|//with the same prefix
name|String
name|prefix
init|=
name|NamespaceMappingUtils
...
name|IllegalStateException
argument_list|(
literal|"Missing Namespace "
operator|+
literal|"Prefix mapping for Prefix '"
operator|+
name|prefix
operator|+
literal|"'!"
...
expr_stmt|;
block|}
comment|//else this entity does not use a prefix
block|}
name|log
operator|.
name|debug

...
name|appendMode
decl_stmt|;
comment|/**      * Default constructor. Expects that {@link #setConfiguration(Map)} is      * called to initialise the instance      */
specifier|public
name|LdpathSourceProcessor
parameter_list|()
block|{     }
comment|/**      * Initializes the {@link LdpathSourceProcessor} with the parsed parameters and      * appendMode enabled      * @param backend the {@link RDFBackend} to use for executing the program      * @param program the {@link Program} to be executed by this processor for      * entities to process      */
annotation|@
name|SuppressWarnings
argument_list|(
block|{
...
expr_stmt|;
block|}
comment|/**      * Initializes the {@link LdpathSourceProcessor} with the parsed parameters      * @param backend the {@link RDFBackend} to use for executing the program      * @param program the {@link Program} to be executed by this processor for      * entities to process      * @param appendMode if<code>true</code> results of the {@link LDPath} execution      * will be appended to parsed {@link Representation}. If<code>false</code> the      * results of this processor will be added to a new {@link Representation} -      * meaning that fields of the input will not be present in the processing      * results      */
annotation|@
name|SuppressWarnings
argument_list|(
block|{
...
name|trace
argument_list|(
literal|" - process {} (backend: {}, program: {}, append: {})"
argument_list|,
name|source
operator|.
name|getId

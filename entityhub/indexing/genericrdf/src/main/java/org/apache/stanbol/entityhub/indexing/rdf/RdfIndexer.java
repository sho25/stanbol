...
name|KEY_RDF_FILES
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.rdfFiles"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.fieldMappings"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.indexingDir"
decl_stmt|;
...
name|KEY_MODEL_NAME
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.modelName"
decl_stmt|;
...
name|KEY_RDF_TYPES
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.indexedTypes"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.indexingMode"
decl_stmt|;
...
name|KEY_SKIP_READ
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.skipRead"
decl_stmt|;
...
name|KEY_CHUNK_SIZE
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.chunkSize"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.entityRankings"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.ignoreEntitiesWithoutRankings"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.requiredRanking"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.defaultRanking"
decl_stmt|;
...
init|=
literal|"org.apache.stanbol.entityhub.indexing.rdf.resumeMode"
decl_stmt|;
specifier|private
specifier|final
name|IndexingMode
...
begin_comment
comment|/** 	 * This Method is used to process the RDF Data if all Resource can be indexed, 	 * because it provides the best performance. Mainly because it reads everything 	 * from a single stream and therefore gives the OS the best opportunities to 	 * optimise file access. 	 * @throws YardException 	 * @see {@link #indexRanked()} 	 */
end_comment
...
begin_comment
comment|/**      * This indexing method uses the list of Entities to index as input, queries      * for the data and indexes them. This performs a query/entity and therefore      * does not provide the same read performance that {@link #indexResources()}.      * However where only a small amount of all entities are indexed, this       * method will be significant faster.       * @throws YardException      */
end_comment

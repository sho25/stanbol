...
name|dest
init|=
name|createQuad2TripleDestination
argument_list|()
decl_stmt|;
name|dest
operator|.
...
return|;
block|}
comment|/**      * Creates a Destination that consumes {@link Quad}s and stores      * {@link Triple}s to the {@link #indexingDataset}      * @return      */
specifier|private
name|Destination
argument_list|<
name|Quad

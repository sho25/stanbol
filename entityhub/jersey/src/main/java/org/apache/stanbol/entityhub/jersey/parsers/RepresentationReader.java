...
name|debug
argument_list|(
literal|"type is {} for {} against Map<String,Representation>"
argument_list|,
name|typeOk
condition|?
literal|"compatible"
...
name|info
argument_list|(
literal|"Read Representations from Request Data"
argument_list|)
expr_stmt|;
name|long
name|start
...
name|info
argument_list|(
literal|"   ... reading request data {}ms"
argument_list|,
name|readingCompleted
operator|-
name|start

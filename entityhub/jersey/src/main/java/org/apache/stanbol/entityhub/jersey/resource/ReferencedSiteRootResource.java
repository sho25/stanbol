...
condition|)
block|{
comment|//enableCORS(servletContext, res, headers, OPTIONS,GET,POST,PUT,DELETE);
block|}
else|else
block|{
comment|//enableCORS(servletContext, res, headers,OPTIONS,GET);
block|}
return|return
name|res
operator|.
...
argument_list|)
decl_stmt|;
comment|//addCORSOrigin(servletContext, builder, headers);
return|return
name|builder
operator|.
name|build
...
argument_list|)
expr_stmt|;
comment|//delete the entity
comment|//return the deleted data
specifier|final
name|MediaType
name|acceptedMediaType
init|=
...
name|add
argument_list|(
literal|"http://www.w3.org/2000/01/rdf-schema#description"
argument_list|,
name|config
operator|.
name|getDescription
...
name|add
argument_list|(
literal|"http://creativecommons.org/ns#attributionName"
argument_list|,
name|config
operator|.
name|getAttribution
...
name|add
argument_list|(
literal|"http://creativecommons.org/ns#attributionURL"
argument_list|,
name|config
operator|.
name|getAttributionUrl
...
name|add
argument_list|(
literal|"http://purl.org/dc/terms/license"
argument_list|,
name|licenseUrl
argument_list|)
expr_stmt|;
...
name|add
argument_list|(
literal|"http://creativecommons.org/ns#licenseUrl"
argument_list|,
name|license
operator|.
name|getUrl

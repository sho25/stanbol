...
begin_comment
comment|//TODO rather than having the siteId as path param here instances of this class
end_comment

begin_comment
comment|//should be returned as subresource
end_comment
...
argument_list|)
expr_stmt|;
comment|//addCORSOrigin(servletContext, rb, header);
return|return
name|rb
operator|.
name|build
...
argument_list|)
decl_stmt|;
comment|//CorsHelper.addCORSOrigin(servletContext, rb, header);
return|return
name|rb
operator|.
name|build
...
block|{
comment|//TODO: maybe throw an Exception instead
name|log
operator|.
name|warn
argument_list|(
literal|"Unknown prefix '{}' used by Google Refine query parameter of property '{}'! "
operator|+
literal|"Will use the full text field as fallback"
argument_list|,
name|NamespaceMappingUtils
operator|.
name|getPrefix

...
name|value
operator|=
literal|"The human readable name"
argument_list|)
block|,
annotation|@
name|Property
...
name|GRAPH_URI
init|=
literal|"org.apache.stanbol.entityhub.yard.clerezza.graphuri"
decl_stmt|;
...
name|info
argument_list|(
literal|"  ... (re)use existing Graph {} for Yard {}"
argument_list|,
name|yardGraphUri
argument_list|,
name|config
...
name|info
argument_list|(
literal|"   ... create new Graph {} for Yard {}"
argument_list|,
name|yardGraphUri
argument_list|,
name|config
...
condition|)
block|{
comment|//within an OSGI environment
comment|//Register the graph with the Stanbol SPARQL endpoint (STANBOL-677)
name|Dictionary
argument_list|<
name|String
argument_list|,
...
expr_stmt|;
block|}
comment|//else do not register when running outside OSGI
block|}
annotation|@
name|Deactivate
specifier|protected
...
expr_stmt|;
block|}
comment|//            if(isRepresentation(resource)){
comment|//                graph.removeAll(createRepresentationGraph(resource, graph));
...
block|}
block|}
comment|/**      * @return      * @throws YardException      */
specifier|private
name|Lock
name|writeLockGraph
parameter_list|()
...
name|YardException
argument_list|(
literal|"Unable modify data in ClerezzaYard '"
operator|+
name|getId
argument_list|()
operator|+
literal|"' because the backing RDF graph '"
operator|+
name|yardGraphUri
operator|+

...
block|{
comment|// NOTE that not all regex queries can be supported by Solr
comment|// see https://issues.apache.org/jira/browse/LUCENE-2604
name|StringBuilder
name|sb
init|=
operator|new
...
block|}
block|}
comment|//else ignore null element
block|}
if|if
condition|(
name|value

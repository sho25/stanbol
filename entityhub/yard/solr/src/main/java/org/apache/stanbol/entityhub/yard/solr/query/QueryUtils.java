...
parameter_list|()
block|{}
comment|/**      * The {@link TokenizerFactory} used to create Tokens for parsed       * {@link IndexValue#getValue()} in case<code>false</code> is parsed for      * the tokenize property of {@link #encodeQueryValue(IndexValue, boolean)}.      *<p>      * Currently the {@link ICUTokenizerFactory} is used for Tokenizing.      */
specifier|private
specifier|final
specifier|static
name|TokenizerFactory

...
decl_stmt|;
comment|/**      * Key used to to enable/disable the default configuration. If this is enabled,      * that the index will get initialised with the Default configuration.<p>      * Notes:<ul>      *<li> Configuration is only supported for EmbeddedSolrServers that use a      * relative path      *<li> If this property is enabled the value of the       * {@link #SOLR_INDEX_CONFIGURATION_NAME} will be ignored.      *</ul>      * Only applies in case a {@link EmbeddedSolrServer} is used.      * @see SolrYardConfig#isDefaultInitialisation()      * @see SolrYardConfig#setDefaultInitialisation(Boolean)      */
specifier|public
specifier|static
specifier|final
name|String
...
literal|"default"
decl_stmt|;
comment|/**      * Allows to configure the name of the index used for the configuration of the Solr Core.      * Only applies in case of using an {@link EmbeddedSolrServer} and      * {@link #SOLR_INDEX_DEFAULT_CONFIG} is disabled.      * As default the value of the {@link #SOLR_SERVER_LOCATION} is used.      * @see SolrYardConfig#getIndexConfigurationName()      * @see SolrYardConfig#setIndexConfigurationName(String)      */
specifier|public
specifier|static
specifier|final
name|String

...
name|bind
operator|=
literal|"bindSolrDirectoryManager"
argument_list|,
name|unbind
operator|=
literal|"unbindSolrDirectoryManager"
argument_list|)
specifier|private
name|SolrDirectoryManager
name|solrDirectoryManager
...
specifier|protected
name|void
name|unbindSolrDirectoryManager
parameter_list|(
name|SolrDirectoryManager
name|manager
parameter_list|)
...
return|;
block|}
comment|/**      * @param config      * @throws ConfigurationException      * @throws YardException       */
specifier|private
name|SolrServer
name|getServer
parameter_list|()
...
name|format
argument_list|(
literal|"Unable to init SolrServer because %s service is not present"
argument_list|,
name|SolrDirectoryManager
operator|.
name|class
...
name|debug
argument_list|(
literal|"Deactivate SolrYard with SolrServer that was never initialised"
argument_list|)
expr_stmt|;
block|}
catch|catch

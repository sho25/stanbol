...
return|;
block|}
comment|/**      * The Entityhub {@link DataTypeEnum datatypes} mapped to this SolrYard      * {@link IndexDataType}      * @return the mapped {@link DataTypeEnum}s      */
specifier|public
name|Set
argument_list|<
name|DataTypeEnum
argument_list|>
name|getMappedDataTypes
parameter_list|()
block|{
return|return
name|dataTypes
...
expr_stmt|;
block|}
comment|//inverse mappings for IndexDataTypesEnum -> DataTypeEnum
for|for
control|(
name|DataTypeEnum
name|mdt
...
name|format
argument_list|(
literal|"Found multiple IndexDataTypes are mapped with DataType %s!"
argument_list|,
name|mdt
argument_list|)
argument_list|)
...
return|;
block|}
comment|/**      * Lookup table for the IndexDataTypeEnum based on the Entityhub {@link DataTypeEnum}      * @param dt the {@link DataTypeEnum}      * @return the {@link IndexDataTypeEnum} or<code>null</code> if the parsed datatype is not mapped.      */
specifier|public
specifier|static
name|IndexDataTypeEnum
name|forDataTyoe

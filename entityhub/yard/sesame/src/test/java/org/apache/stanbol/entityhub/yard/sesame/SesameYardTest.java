...
name|createURI
argument_list|(
literal|"urn:test.sesameyard:bnodesupport.subject"
argument_list|)
decl_stmt|;
name|URI
name|property
...
name|createURI
argument_list|(
literal|"urn:test.sesameyard:bnodesupport.property"
argument_list|)
decl_stmt|;
name|URI
name|value
...
name|createURI
argument_list|(
literal|"urn:test.sesameyard:bnodesupport.value"
argument_list|)
decl_stmt|;
name|URI
name|property2
...
name|createURI
argument_list|(
literal|"urn:test.sesameyard:bnodesupport.property2"
argument_list|)
decl_stmt|;
name|URI
name|loop1
...
name|createURI
argument_list|(
literal|"urn:test.sesameyard:bnodesupport.loop1"
argument_list|)
decl_stmt|;
name|URI
name|loop2
...
name|createURI
argument_list|(
literal|"urn:test.sesameyard:bnodesupport.loop2"
argument_list|)
decl_stmt|;
name|BNode
name|bnode1
...
argument_list|()
decl_stmt|;
comment|//Assert for the indirect statements to be present in the model
name|Assert
operator|.
name|assertFalse
argument_list|(

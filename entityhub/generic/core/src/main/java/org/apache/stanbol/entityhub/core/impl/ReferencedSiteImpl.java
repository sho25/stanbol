...
return|;
block|}
comment|/**      * Initialises the {@link Entity#getMetadata()} with the properties      * configured for this site (attribution and license information)      * @param entity the entity      * @param of this Entity is locally cached or not. If<code>null</code>      * this information is not set in the metadata.      */
specifier|private
name|void
name|initEntityMetadata
parameter_list|(

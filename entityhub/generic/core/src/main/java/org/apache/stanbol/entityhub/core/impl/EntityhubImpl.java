...
return|;
block|}
comment|/**      * Loads an Entity (Representation and Metadata) form the parsed Yard      * @param entityhubYard the yard used by the Entityhub      * @param id the ID of the Entity to load      * @return the Entity or<code>null</code> if not found      * @throws YardException On any error with the parsed Yard.      */
specifier|private
name|Entity
name|loadEntity
parameter_list|(
...
return|;
block|}
comment|/**      * Loads the metadata for the parsed representation form the parsed Yard      * and creates the Entity. If no metadata are found a new Representation      * is created.      * @param entityhubYard the yard used by the Entityhub      * @param representation the representation of the entity      * @return the created Entity including the loaded/created metadata      * @throws YardException On any error with the parsed Yard.      */
specifier|private
name|Entity
name|loadEntity
parameter_list|(
...
block|}
block|}
comment|/**      * Stores both the Representation and the Metadata of the parsed Entity to the      * parsed yard.      * @param entityhubYard the Yard used to store the Entity      * @param entity the stored entity      * @throws YardException      */
specifier|private
name|void
name|storeEntity
parameter_list|(

...
condition|)
block|{
comment|//the metadata are about a different Entity ->
throw|throw
operator|new
name|IllegalArgumentException
argument_list|(
...
name|format
argument_list|(
literal|"The Metadata of the parsed Entity are not about the Entity ("
operator|+
literal|"entity: %s | metadataId: %s | metadataAbout: %s)"
argument_list|,
name|entity
operator|.
name|getRepresentation
...
throw|;
block|}
comment|//else the ID value is OK
return|return
operator|new
name|ManagedEntity
argument_list|(

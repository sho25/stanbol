...
expr_stmt|;
block|}
comment|/**      * Comparator based on the {@link RdfResourceEnum#resultScore} property that      * assumes that values of this property implement {@link Comparable}. The      * Representation with the highest score will be first      */
specifier|public
specifier|static
specifier|final
name|Comparator

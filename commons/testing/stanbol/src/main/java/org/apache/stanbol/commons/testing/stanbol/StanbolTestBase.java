...
name|executor
decl_stmt|;
comment|/**      * Overwrite to enable authentication for requests      * @return the<code>username:password</code> or<code>null</code> to deactivate      * authentication (default)      */
specifier|protected
name|String
name|getCredentials
parameter_list|()
...
argument_list|)
expr_stmt|;
comment|//TODO:user name and pwd
name|String
name|credentials
init|=
name|getCredentials

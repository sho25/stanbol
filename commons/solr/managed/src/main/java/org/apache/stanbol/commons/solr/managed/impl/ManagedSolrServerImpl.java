...
name|info
argument_list|(
literal|"IndexArchive {} unavailable ..."
argument_list|,
name|resource
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"IndexArchive {} available ..."
argument_list|,
name|resourceName
argument_list|)
expr_stmt|;
...
name|IllegalArgumentException
argument_list|(
literal|"The parsed IndexMetadata MUST NOT be NULL"
argument_list|)
throw|;
block|}
name|String
...
name|IllegalArgumentException
argument_list|(
literal|"The parsed IndexMetadata MUST contain a valid name (NOT NULL and NOT empty)!"
argument_list|)
throw|;
block|}
if|if
...
name|info
argument_list|(
literal|"Update Request for {} (server: {}, desired state: {}, from Archive: {})"
argument_list|,
operator|new
name|Object
index|[]
...
condition|)
block|{
comment|//IndexMetadata metadata = managedCores.getIndexMetadata(entry.getKey());
name|IndexActionInfo
name|info
init|=
name|entry
...
name|info
argument_list|(
literal|"ingonre Update request for Index {} with desired state {} "
operator|+
literal|"because this index seams to be no longer managed!"
argument_list|,
name|entry
operator|.
name|getKey

...
name|IllegalStateException
argument_list|(
literal|"Unable to initialise XML parsers for parsing 'solr.xml'"
argument_list|,
name|e
argument_list|)
throw|;
...
name|IllegalStateException
argument_list|(
literal|"Unable to access Solr base directory '"
operator|+
name|managedSolrDir
operator|+
literal|"'!"
...
name|IllegalStateException
argument_list|(
literal|"Error while parsing 'solr.xml' within "
operator|+
literal|"directory '"
operator|+
name|managedSolrDir
...
name|IllegalStateException
argument_list|(
literal|"Unable to configure XML parser for parsing"
operator|+
literal|"configurations for SolrCore '"
operator|+
name|coreName
operator|+
literal|"'(dir:+"
...
name|IllegalStateException
argument_list|(
literal|"Unable to parse configuratin for SolrCore '"
operator|+
name|coreName
operator|+
literal|"'(dir:+"

...
argument_list|(
literal|"The parsed SolrDirectoryManager MUST NOT be NULL"
argument_list|)
throw|;
block|}
name|this
...
condition|)
block|{
comment|// no index with that name installed -> nothing to do
name|ctx
operator|.
name|log
argument_list|(
...
name|format
argument_list|(
literal|"SolrIndex '%s' not installed. Nothing to uninstall"
argument_list|,
name|indexName
argument_list|)
argument_list|)
...
comment|//solrDirectoryManager.removeSolrIndex()
name|log
operator|.
name|warn
argument_list|(
literal|"Uninstalling of SolrIndexes not yet Implemented -> marking as uninstalled (see STANBOL-287)"
argument_list|)
expr_stmt|;
name|setFinishedState
argument_list|(

...
argument_list|()
decl_stmt|;
comment|/**      * The {@link ComponentContext} as set in the {@link #activate(ComponentContext)}      * method      */
specifier|private
name|ComponentContext
name|context
decl_stmt|;
...
condition|)
block|{
comment|//create an EmbeddedSolrServer
return|return
operator|new
name|EmbeddedSolrServer
argument_list|(
...
name|info
argument_list|(
literal|"Internally Managed SolrServer does not know a SolrCore with the name '{}'"
argument_list|,
name|uriOrPath
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Internally Managed SolrServer not available: Unable to lookup SolrCore '{}'!"
argument_list|,
name|uriOrPath
argument_list|)
expr_stmt|;
...
name|format
argument_list|(
literal|"The parsed Index Path '%s' does not "
operator|+
literal|"refer to an internally managed SolrServer nor to a Directory on the FileSystem"
argument_list|,
name|uriOrPath
argument_list|)
argument_list|)
throw|;
block|}
comment|//TODO: refactor that so that also external SolrServer are initialised
comment|//      using ManagedSsolrServerImpl
name|log
operator|.
name|info
argument_list|(

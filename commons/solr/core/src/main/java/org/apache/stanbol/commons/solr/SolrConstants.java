...
literal|"schema.xml"
decl_stmt|;
comment|/**      * Key used to store the name of the {@link AbstractAnalysisFactory}. This is      * the lower case version of the actual name excluding the detected      * suffix.<p>      * This property is added to {@link AbstractAnalysisFactory} instanced      * registered as OSGI services to workaround the SPI typically used by Solr 4      * to find anayzer factory instances.      */
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"org.apache.lucene.analysis.factory.name"
decl_stmt|;
specifier|public
specifier|static
specifier|final

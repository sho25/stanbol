...
begin_comment
comment|/**  * Implementation of the {@link SolrServerProvider} interface supporting all the types directly supported by  * the SolrJ library. This includes all Clients using the RESTful API of a   * SolrServer.  *<p>  * This does not support an embedded SolrServer  *   * @author Rupert Westenthaler  *   */
end_comment
...
specifier|public
class|class
name|RESTfulSolrServerProvider

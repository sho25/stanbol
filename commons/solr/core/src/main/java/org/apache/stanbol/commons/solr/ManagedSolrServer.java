...
argument_list|)
expr_stmt|;
comment|//now register the cores
for|for
control|(
name|String
name|name
...
argument_list|)
expr_stmt|;
comment|//(re-)register the two cores
name|registerCoreService
argument_list|(
name|core1
argument_list|,
...
parameter_list|)
block|{
comment|/*          * TODO: Validate if it is a good Idea to decrease the reference count          * until the SolrCore is closed.          */
if|if
condition|(
name|old
operator|==
...
name|warn
argument_list|(
literal|"Old SolrCore was not Closed correctly - this indicates that some other"
operator|+
literal|"components calling CoreContainer#getSolrCore() has not colled SolrCore#close()"
operator|+
literal|"after using it."
argument_list|)
expr_stmt|;
name|log
operator|.
name|warn
argument_list|(
literal|"To avoid memory leaks this will call SolrCore#close() until closed"
argument_list|)
expr_stmt|;
name|int
name|i
...
name|warn
argument_list|(
literal|"   ... called SolrCore#close() {} times before closed"
argument_list|,
name|i
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Returns the ServiceReference for the {@link SolrServer} of the core      * with the parsed name      * @param name the name of the core      * @return the reference to the {@link SolrServer} or<code>null</code> if      * not managed.      */
specifier|public
name|ServiceReference
name|getCore
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Internally used to manage the OSGI service registration for      * {@link SolrCore}s of the {@link CoreContainer} managed by this      * {@link ManagedSolrServer} instance      * @author Rupert Westenthaler      *      */
specifier|private
class|class
name|CoreRegistration
block|{
...
block|}
block|}
comment|/**      * {@link Dictionary} implementation that provides getter and setter for      * typical properties configured for a {@link ManagedSolrServer}.<p>      * Stores its state in the {@link Dictionary} and implements {@link Cloneable}      * @author Rupert Westenthaler      */
specifier|public
specifier|static
class|class
name|SolrServerProperties
...
block|}
block|}
comment|/**      * {@link Dictionary} implementation that provides getter and setter for      * typical properties configured for a {@link SolrCore} registered to a       * {@link ManagedSolrServer}.<p>      * Stores its state in the {@link Dictionary} and implements {@link Cloneable}      * @author Rupert Westenthaler      */
specifier|public
specifier|static
class|class
name|SolrCoreProperties
...
name|IllegalArgumentException
argument_list|(
literal|"The parsed File MUST represent a Directory!"
argument_list|)
throw|;
block|}
block|}

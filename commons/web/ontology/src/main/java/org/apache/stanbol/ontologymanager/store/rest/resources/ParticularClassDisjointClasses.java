...
name|Path
argument_list|(
literal|"/ontology/{ontologyPath:.+}/classes/{classPath:.+}/disjointClasses/"
argument_list|)
specifier|public
class|class
...
name|Path
argument_list|(
literal|"/ontologymanager/store{disjointClassPath:.+}"
argument_list|)
specifier|public
name|Response
name|removeDisjointClass
parameter_list|(
annotation|@
name|PathParam
argument_list|(
...
name|PathParam
argument_list|(
literal|"disjointClassPath"
argument_list|)
name|String
name|disjointClassPath
parameter_list|)
block|{
name|LockManager
name|lockManager

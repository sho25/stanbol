...
begin_comment
comment|/**  * The JsonLd class provides an API to create a JSON-LD object structure and to serialize this structure.  *   *<p>  * This implementation is based on the JSON-LD 1.0 specification editor's draft from  * January 5, 2013. Available online at<a href="http://json-ld.org/spec">http://json-ld.org/spec</a>.  */
end_comment
...
expr_stmt|;
block|}
comment|// Check if there is a namespace defined for this property
name|String
name|removeNs
init|=
literal|null
...
condition|)
block|{
comment|// If the returned value object contains only one @value value,
comment|// we can simplify the value by admitting the @value.

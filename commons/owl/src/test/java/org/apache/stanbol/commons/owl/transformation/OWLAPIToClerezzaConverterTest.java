...
specifier|public
name|void
name|testGraphToOWLOntology
parameter_list|()
block|{
comment|/*          * Transform the Clerezza Graph to an OWLOntology.          */
name|OWLOntology
name|ontology
init|=
name|OWLAPIToClerezzaConverter
...
specifier|public
name|void
name|testOWLOntologyToGraph
parameter_list|()
block|{
comment|/*          * Transform the OWLOntology into a Clerezza Graph.          */
name|Graph
name|mGraph
init|=
name|OWLAPIToClerezzaConverter

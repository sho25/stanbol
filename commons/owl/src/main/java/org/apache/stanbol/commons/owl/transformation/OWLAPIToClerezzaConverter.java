...
return|;
block|}
comment|/**      *       * Converts a OWL API {@link OWLOntology} to Clerezza {@link Graph}.      *       * @param ontology      *            {@link OWLOntology}      * @return the equivalent Clerezza {@link Graph}.      */
specifier|public
specifier|static
name|org
operator|.
...
return|;
block|}
comment|/**      * Converts a Clerezza {@link Graph} to an OWL API {@link OWLOntology}.      *       * @param mGraph      *            {@link org.apache.clerezza.commons.rdf.Graph}      * @return the equivalent OWL API {@link OWLOntology}.      */
specifier|public
specifier|static
name|OWLOntology

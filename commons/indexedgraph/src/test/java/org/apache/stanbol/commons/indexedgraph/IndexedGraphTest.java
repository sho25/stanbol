...
expr_stmt|;
block|}
comment|/**      * Holds the test data to perform       * {@link Graph#filter(BlankNodeOrIRI, IRI, RDFTerm)}      * tests on {@link Graph} implementations      * @author rwesten      */
specifier|public
specifier|static
specifier|final
class|class
...
argument_list|)
expr_stmt|;
comment|//Simple ImmutableGraph reference test
name|TestCase
name|testCase
init|=
operator|new

...
literal|0
operator|&&
comment|//same string representation -> should be equals
name|a
operator|instanceof
name|BNode
operator|&&
comment|//but for BNodes it might be a hashcode conflict
operator|!
name|a
operator|.
name|equals
...
condition|)
block|{
comment|//so check if they are not equals
name|log
operator|.
name|info
argument_list|(
literal|"HashCode conflict for {} and {}"
argument_list|,
name|a
argument_list|,
name|b
...
return|;
block|}
comment|//no conflict or no conflict possible
return|return
name|state
return|;
block|}

...
name|buildTypes
decl_stmt|;
comment|/**      * Creates an instance for the given language based on the configuration      * within the {@link PosTagsCollectionEnum}.      * @param lang The language      * @return the instance or<code>null</code> if no configuration for the      * parsed language is present in the {@link PosTagsCollectionEnum}.      */
specifier|public
specifier|static
name|PosTypeChunker
name|getInstance
...
return|;
block|}
comment|/**      * Build the chunks based on the parsed tokens and tags.<p>      * This method is the equivalent to       * {@link opennlp.tools.chunker.Chunker#chunkAsSpans(String[], String[])}      * @param tokens the tokens      * @param tags the POS tags for the tokens      * @return the chunks as spans over the parsed tokens      */
specifier|public
name|Span
index|[]
name|chunkAsSpans

...
comment|/**      * Endpoint-style user creation takes a little bunch of Turtle e.g. [] a      * foaf:Agent ; cz:userName "Hugo Ball" .      *      * @param userData      * @return HTTP/1.1 204 No Content      */
annotation|@
name|POST
annotation|@
name|Consumes
...
return|;
block|}
comment|/**      * RESTful access to individual user data      *      * @param userName      * @return context graph for user      * @throws UnsupportedEncodingException      */
annotation|@
name|GET
annotation|@
name|Path
...
return|;
block|}
comment|/// LOCKS MAYBE OK TO HERE
comment|/**      * RESTful access to user roles (and permissions right now - may change)      *      * @param userName      * @return context graph for user      * @throws UnsupportedEncodingException      */
annotation|@
name|GET
annotation|@
name|Path

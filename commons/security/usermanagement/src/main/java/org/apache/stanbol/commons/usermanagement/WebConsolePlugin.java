...
name|templateLoader
decl_stmt|;
comment|/** 	 * The TemplateEngine used to render user information 	 */
specifier|private
name|TemplateEngine
argument_list|<
name|Resource
...
argument_list|)
expr_stmt|;
comment|//use some getter to get the Graph that backups the UserManager
comment|//TODO: a direct getter for the graph would be nice to have
name|templateEngine
operator|=
operator|new
name|TemplateEngine

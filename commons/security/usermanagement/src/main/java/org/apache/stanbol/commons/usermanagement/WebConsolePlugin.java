...
name|RdfViewable
argument_list|(
literal|"org/apache/stanbol/commons/usermanagement/webConsole.ftl"
argument_list|,
name|userManager
operator|.
name|getUserType
...
argument_list|)
decl_stmt|;
comment|//now use the LdViewableWriter to serialize
name|rdfViewableWriter
operator|.
name|writeTo
argument_list|(

...
specifier|public
name|void
name|testInitialisationWithoutLocalMappingFIle
parameter_list|()
throws|throws
name|IOException
block|{
...
literal|"dummy"
argument_list|,
literal|"http://www.dummy.org/dummy#"
argument_list|)
expr_stmt|;
name|Assert
operator|.
...
name|ByteArrayInputStream
argument_list|(
literal|"dummy2\thttp://www.dummy.org/dummy2#"
operator|.
name|getBytes
argument_list|(
name|Charset
...
name|assertEquals
argument_list|(
literal|"http://www.dummy.org/dummy2#"
argument_list|,
name|service
operator|.
name|getNamespace

...
name|warn
argument_list|(
literal|"Response from prefix.cc does have the wrong content type '"
operator|+
name|contentType
operator|+
literal|"' (expected: text/plain). This indicates that the "
operator|+
literal|"service is currently unavailable!"
argument_list|)
expr_stmt|;
block|}
name|con
...
argument_list|()
expr_stmt|;
comment|//we connect once every {long-period}
block|}
catch|catch
parameter_list|(
name|IOException
